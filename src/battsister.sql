...
-- ----------------------------
-- Table structure for `bs_course_class`
-- ----------------------------
DROP TABLE IF EXISTS `bs_course_class`;
CREATE TABLE `bs_course_class` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='课程栏目表';

-- ----------------------------
-- Records of bs_course_class
-- ----------------------------
...
CREATE TABLE `bs_little_chapter` (
  ...
  `chapter_id` int(11) DEFAULT '0' COMMENT '章节ID',
  `course_id` int(11) DEFAULT '0' COMMENT '课程ID',
  `study_guide` varchar(256) DEFAULT '' COMMENT '学习指南',
  `teach_gude` varchar(256) DEFAULT '' COMMENT '教学指南',
  `teach_commont` varchar(256) DEFAULT '' COMMENT '教学评价',
  `teach_plan` varchar(256) DEFAULT '' COMMENT '教案',
...
CREATE TABLE `bs_news` (
  ...
  `isdel` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=72 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='新闻列表';
...
CREATE TABLE `bs_news_class` (
  ...
  `isdel` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=528619506 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='新闻栏目';
...
CREATE TABLE `bs_schools` (
  ...
  `add_time` bigint(20) DEFAULT '0' COMMENT '添加时间',
  `start_time` bigint(20) DEFAULT '0' COMMENT '合作开始时间',
  `end_time` bigint(20) DEFAULT '0' COMMENT '合作结束时间',
  `beizhu` longtext COMMENT '备注',
  `flag` varchar(100) DEFAULT NULL COMMENT '权限',
  `weburl` varchar(100) DEFAULT '' COMMENT '网址',
  `logo` varchar(100) DEFAULT '' COMMENT '小logo',
  `big_logo` varchar(100) DEFAULT '' COMMENT '大logo',
  `isdel` int(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=158 DEFAULT CHARSET=utf8 COMMENT='学校表';

-- ----------------------------
-- Records of bs_schools
-- ----------------------------
INSERT INTO bs_schools VALUES ('156', '龙华医院', '民清路18号', '0755-12345678', '', '', '龙先生', '0', '', '1446626131', '0', '0', '', '', 'www.hanyouapp.com', '', '', '0');
INSERT INTO bs_schools VALUES ('157', '测试1', '展滔', '13729009649', '', '', '陈', '0', '', '1448262055', '0', '0', '', '', '', '', '', '0');
...
CREATE TABLE `bs_sys_feedback` (
  ...
  `content` longtext COLLATE utf8_bin COMMENT '内容，当是第三方申请时，格式为json{"companyName":"ddd","companyAddress":"ddd","contactMan":"ddd","contactPhone":"13556750524","otherExplain":"ddd"}',
  `add_time` bigint(20) DEFAULT '0' COMMENT '提交时间',
  `type` tinyint(4) DEFAULT '0' COMMENT '类型，0是用户反馈',
  `isdel` int(11) DEFAULT '0' COMMENT '0为正常、1为已删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='学生反馈表';
...
INSERT INTO bs_sys_keyword VALUES ('4283', '出售手枪货到付款', '', '0', '1429776663000', '0');
...
CREATE TABLE `bs_sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8305 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='操作日志表';
...
CREATE TABLE `bs_sys_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='管理员表';

-- ----------------------------
-- Records of bs_sys_user
-- ----------------------------
INSERT INTO bs_sys_user VALUES ('1', 'xhq', '965eb72c92a549dd', , '0', '127.0.0.1', '1429776663000', '127.0.0.1', '1456216512000', '0', '0');
INSERT INTO bs_sys_user VALUES ('8', 'www', '965eb72c92a549dd', 0x2C2C2C2C2C2C2C, '0', '127.0.0.1', '1429776900000', '', '0', '0', '0');
INSERT INTO bs_sys_user VALUES ('9', 'eee', '965eb72c92a549dd', 0x2C2C2C2C2C2C2C, '0', '127.0.0.1', '1429776941000', '', '0', '0', '1');
INSERT INTO bs_sys_user VALUES ('13', 'xiaoshen', '965eb72c92a549dd', 0x2C2C2C2C2C2C2C, '0', '218.17.13.49', '1440578083000', '', '0', '0', '0');
...
CREATE TABLE `bs_teachers` (
  ...
  `school_id` int(11) DEFAULT '0' COMMENT '学校ID',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=245 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='教师表';
...
CREATE TABLE `bs_upfile` (
  ...
  `isdel` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1917 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='上传的图片、视频地址表';
