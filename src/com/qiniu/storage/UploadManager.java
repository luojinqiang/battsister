...
public final class UploadManager {
    ...
    public static void main(String[] args) {
		...
		try {
			Response response=uploadManager.put(file, "test.jpg",auth.uploadToken("myspace"));
			System.out.println("statusCode->"+response.statusCode+"&bodyString-->"+response.bodyString());
			System.out.println("address->"+response.address+"&error-->"+response.error);
