...
public class Teacher {
	...
	public JSONObject checkTeacherLogin(HttpServletRequest request){
        ...
        try {
            ...
            Doc teacherDoc = base.executeQuery2Docs("select id,password,account_status,name,username,login_err_times from bs_teachers where isdel=0 and username=? ", new Object[]{user_name}, 1)[0];
            ...
            if (UserPasswordDes.equals(teacherDoc.get("password"))) {
                base.executeUpdate("update bs_teachers set login_err_times=0,last_login_ip=?,last_login_time=? where id=?", new Object[]{ru.getIps(), createTime, teacherDoc.getI("id")});
