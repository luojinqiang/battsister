...
<div class="container">
	<div class="ex_wrap">
		<div class="title_test"><%=examDoc.get("name")%><div class="time_s"><i>考试时长：<%=examDoc.get("limit_time")%>分钟</i>剩余时间<em id="h">00</em>:<em id="m"><%=examDoc.getIn("limit_time")%></em>:<em id="s">00</em></div></div>
            ...
            <%
                ...
                if (examList != null && !examList.isEmpty()) {
                    ...
                    for (Doc doc : examList) {
                        ...
                        type = doc.getIn("type");
                        %>
            <div id="exam" <%=1 != i?"style=\"display:none;\"":""%>>
                <div class="ex_one_title">
                    <em><%=type==1?"多选":type==2?"判断题":"单选"%></em>
                        ...
                        if (type != 2) {
                            ...
                            if (!array.isEmpty()) {
                                for (Object o : array) {
                                    ...
                                    out.print("<li><input name=\"\" type=\"radio\" value=\""+object.get("id")+"\"  class=\"input_radio\">D、"+object.get("name")+"</li>");
                                }
                            }
                        } else {
                            %>
                    <li><input name="" type="radio" value="0" class="input_radio">A、错误</li>
                    <li><input name="" type="radio" value="1" class="input_radio">B、正确</li>
                    <%
                        }
                    %>
                </ul>
                <div class="test_b">
                    <div class="test_botton1"><a href="#">上一题</a></div>
                    <div class="test_botton"><a href="take_test1.html">下一题</a></div>
                    <div class="clear"></div>
                </div>
            </div>
            <%
