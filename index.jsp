...
<%
 ...
 List<Doc> newsList=selectic.Get_List("id,newstitle,smallfile,addtime,note", "bs_news"," where isdel=0 and newsclass=? order by ordernum asc,addtime desc limit 6  ", "mysqlss",new Object[]{newsClassId});
 //合作企业、院校
