            ...
            <div class="mr_frUl">
                <ul>
                  <%
                    	...
                    	for(int i=0;i<index;i++){
                    		out.print("<li>");
                    		out.print("<p><a href=\""+(!"".equals(cooperationList1.get(i*2).get("weburl"))?cooperationList1.get(i*2).get("weburl"):"javascript:void(0);")+"\" target=\"_blank\"><img src=\""+cooperationList1.get(i*2).get("pic")+"\"/></a></p>");
                    		if(i*2+1<size){
