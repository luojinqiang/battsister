...
(function ($) {
    ...
    function _2cd(_2ce, _2cf, _2d0) {
        ...
        function _2d5() {
            ...
            if (_2cf == "east") {
                return {
                    resizeC: {width: _2d1.center.panel("options").width + _2d1["east"].panel("options").width - 28},
                    expand: {left: cc.width() - _2d1["east"].panel("options").width},
                    expandP: {
                ...
                if (_2cf == "west") {
                    return {
                        ...
                        collapse: {left: -_2d1["west"].panel("options").width}
                    };
                } else {
                    if (_2cf == "north") {
                        var hh = cc.height() - 28;
                        ...
                        return {
                            ...
                            collapse: {top: -_2d1["north"].panel("options").height}
                        };
                    } else {
                        if (_2cf == "south") {
                            var hh = cc.height() - 28;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _2d1["south"].panel("options").height},
                ...
                if (_2d9 == "west" && _2da.expandWest) {
                    ...
                    if (_2d9 == "north" && _2da.expandNorth) {
                        ...
                        if (_2d9 == "south" && _2da.expandSouth) {
                            return {
                                collapse: {top: cc.height()},
                                expand: {top: cc.height() - _2da["south"].panel("options").height}
                            };
                        }
                    }
                }
