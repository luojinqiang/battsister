	...
	if(ppt_path!=null&&!"".equals(ppt_path)){
		...
		if(pathArray!=null){
			for(int i=0;i<pathArray.size();i++){
				...
				addBuffer.append("<div style=\"margin-top:10px;\"><div>请输入标题：<input type=\"text\" name=\"title\" style=\"width:120;\" value=\""+path_json.optString("title")+"\"/>排序：<input type=\"number\" name=\"order_no\" value=\""+path_json.optInt("order_no")+"\" style=\"max-width:30px;\"/></div><a href=\"/pdf/web/viewer.jsp?file="+path_json.optString("pic_dir")+"\" target=\"_blank\"><img src=\"/public/images/ppt.png\" height=150></a><div class=\"del\">删除</div><input type=\"hidden\" name=\"ppt_pic\" value=\""+
            ...
            <input name="action" id="action" type="hidden" value="save"/>
             ...
             <script type="text/javascript">
                ...
                var callback = function (imgpath,realName) {
                	var append= '<div style="margin-top:10px;"><div>标题：<input type="text" name="title" style="width:120;" value="'+realName+'"/>排序：<input type="number" name="order_no" value="" style="max-width:30px;"/></div><a href="/pdf/web/viewer.jsp?file='+(imgpath)+'" target="_blank"><img src="'
