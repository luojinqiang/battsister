...
<%
    ...
    String order_nos = ru.getString("order_nos");
    ...
    <script type="text/javascript">
        function usersave() {
            ...
            $("input[name=order_no]").each(function () {
                order_no_str += "," + $(this).val();
            });
            $.ajax({
                dataType: "json",
                type: "post",
                url: "video_animation_edit.jsp",
                data: $("#form1").serialize() + "&filePath_str=" + filePath_str + "&title_str=" + title_str + "&order_no_str=" + order_no_str,
    ...
    <div class="box_input">
        <form id="form1" name="form1" method="post" action="">
            ...
            <ul class="row1 clearfix">
                <li>
                    ...
                    <select name="dirName" onchange="getChapterDirByDir(this)">
                        ...
                        %>
                        <option value="<%=json.optString("courseDirName")%>"><%=json.optString("courseDirName")%>
                        </option>
                        <%
                                }
                            }
            ...
            <ul class="row1 clearfix" id="videos">
                ...
                <li>
           			<span>
           		标题：<input type="text" name="title" style="margin-bottom:10px;margin-top:10px;width:180px;"
...
<script type="text/javascript">
    ...
    function addVideo() {
        ...
        var order_nos = '<%=order_nos%>' + ',' + $('input[name=order_no]').val();
        window.location.href = 'video_animation_edit.jsp?id=<%=id%>&titles=' + titles + '&filePaths=' + filePaths + '&type=<%=type%>&order_nos=<%=order_nos%>';
    }
</script>
<!--End Sidebar--> </body>
</html>