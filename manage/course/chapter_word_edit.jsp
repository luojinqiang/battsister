		...
		if(pathArray!=null){
			for(int i=0;i<pathArray.size();i++){
				...
				addBuffer.append("<div style=\"margin-top:10px;\"><div>请输入标题：<input type=\"text\" name=\"title\" style=\"width:120;\" value=\""+path_json.optString("title")+"\"/>排序：<input type=\"number\" name=\"order_no\" value=\""+path_json.optInt("order_no")+"\" style=\"max-width:30px;\"/>"+
						"</div><a href=\"/pdf/web/viewer.html?file="+path_json.optString("pic_dir")+"\" target=\"_blank\"><img src=\"/public/images/word.png\""+
        ...
        <form id="form1" name="form1" method="post" action="">
           ...
           <script type="text/javascript">
                ...
                var callback = function (imgpath,realName) {
                    var append= '<div style="margin-top:10px;"><div>标题：<input type="text" name="title" style="width:120px;" value="'+realName+'"/>排序：<input type="number" name="order_no" value="" style="max-width:30px;"/></div><a href="/pdf/web/viewer.html?file='+(imgpath)+'" target="_blank"><img src="'
