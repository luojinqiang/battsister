...
<%
    ...
    if (action.equals("save")) {//更新
    	...
    	out.print(course.editTeachingGuide(request, user_id, user_name));
    	return;
    }
	String teaching_guide="",name="";
    Doc doc = utildb.Get_Doc("id,teaching_guide,name", "bs_course", " where id=? and isdel=0", "mysqlss", new Object[]{id});
    if (doc == null) {
        out.print("信息不存在");
        return;
    } else {
    	teaching_guide=doc.get("teaching_guide");
    	name=doc.get("name");
    	}
%>
    ...
    <div class="box_input">
        <form id="form1" name="form1" method="post" action="">
            ...
            <input name="action" id="action" type="hidden" value="save"/>
                ...
                <li>
                       <h4 style="margin-bottom:20px;"><%=name%>--教学指南文档上传</h4>
                </li>
            </ul>
            <ul class="row1 clearfix">
                <li>
