(function () {
    ...
    var dtd = dom.dtd = (function () {
        ...
        var A = _({isindex: 1, fieldset: 1}), B = _({
            input: 1,
            button: 1,
            select: 1,
            textarea: 1,
            ...
            em: 1,
            dfn: 1
        }), L = X(_({a: 0}), J), M = _({tr: 1}), N = _({"#": 1}), O = X(_({param: 1}), K), P = X(_({form: 1}), A, D, E, I), Q = _({li: 1}), R = _({
            style: 1,
            script: 1
    ...
    var domUtils = dom.domUtils = {
        ...
        isSameStyle: function (elementA, elementB) {
            var styleA = elementA.style.cssText.replace(/( ?; ?)/g, ";").replace(/( ?: ?)/g, ":"), styleB = elementB.style.cssText.replace(/( ?; ?)/g, ";").replace(/( ?: ?)/g, ":");
            if (browser.opera) {
    ...
    (function () {
        ...
        Editor.prototype = {
            ready: function (fn) {
                ...
                var me = this, headHtml = {html: ""}, html = "";
                ...
                var me = this, inline = utils.extend({a: 1, A: 1}, dtd.$inline, true), lastTagName;
                html = html.replace(/^[ \t\r\n]*?</, "<").replace(/>[ \t\r\n]*?$/, ">").replace(/>[\t\r\n]*?</g, "><").replace(/[\s\/]?(\w+)?>[ \t\r\n]*?<\/?(\w+)/gi, function (a, b, c) {
                    if (b) {
                        lastTagName = c;
                    } else {
    ...
    (function () {
        ...
        UE.commands["unlink"] = {
            execCommand: function () {
                var as, range = new dom.Range(this.document), tds = this.currentSelectedArr, bookmark;
                if (tds && tds.length > 0) {
                    for (var i = 0, ti; ti = tds[i++];) {
        ...
        UE.commands["link"] = {
            queryCommandState: function () {
                ...
                var range = new dom.Range(this.document), tds = this.currentSelectedArr;
                ...
                var range = new dom.Range(this.document), tds = this.currentSelectedArr, as, node;
                if (tds && tds.length) {
                    for (var i = 0, ti; ti = tds[i++];) {
    ...
    UE.commands["touppercase"] = UE.commands["tolowercase"] = {
        execCommand: function (cmd) {
            var me = this, rng = new dom.Range(me.document), convertCase = function () {
    ...
    (function () {
        var block = domUtils.isBlockElm, getObj = function (editor) {
            return utils.findNode(editor.selection.getStartElementPath(), null, function (n) {
    ...
    UE.plugins["rowspacing"] = function () {
        ...
        me.commands["rowspacing"] = {
            execCommand: function (cmdName, value, dir) {
                ...
                var pN = utils.findNode(this.selection.getStartElementPath(), null, function (node) {
                    return domUtils.isBlockElm(node);
                }), value;
                if (pN) {
    ...
    UE.plugins["undo"] = function () {
        ...
        function UndoManager() {
            ...
            this.restore = function () {
                ...
                try {
                    if (browser.opera || browser.safari) {
                        ...
                        range.moveToBookmark({start: "_baidu_bookmark_start_", end: "_baidu_bookmark_end_", id: true});
                    }
            ...
            this.getScene = function () {
                ...
                if (browser.opera || browser.safari) {
                    return {senceRange: new sceneRange(range), content: cont, bookcontent: cont};
                } else {
            ...
            this.save = function () {
                var currentScene = this.getScene(), lastScene = this.list[this.index];
                if (lastScene && lastScene.content == currentScene.content && ((browser.opera || browser.safari) ? lastScene.senceRange.compare(currentScene.senceRange) : lastScene.bookcontent == currentScene.bookcontent)) {
                    return;
                }
                        ...
                        try {
                            ...
                            node = f.filter(node, pasteplain ? {
                                whiteList: {
                                    ...
                                    "tr": {"td": 1, "$": {}},
                                    "td": {"$": {}}
                                }, blackList: {"style": 1, "script": 1, "object": 1}
    ...
    UE.plugins["list"] = function () {
        ...
        me.addListener("keydown", function (type, evt) {
            ...
            var keyCode = evt.keyCode || evt.which;
            if (keyCode == 13) {
                var range = me.selection.getRange(), start = domUtils.findParentByTagName(range.startContainer, ["ol", "ul"], true, function (node) {
        ...
        me.commands["insertorderedlist"] = me.commands["insertunorderedlist"] = {
            execCommand: function (command, style) {
                ...
                return this.highlight ? -1 : utils.findNode(this.selection.getStartElementPath(), [command.toLowerCase() == "insertorderedlist" ? "ol" : "ul"]) ? 1 : 0;
    ...
    (function () {
        ...
        var sourceEditors = {
            textarea: function (editor, holder) {
                ...
                var options = {mode: "text/html", tabMode: "indent", lineNumbers: true, lineWrapping: true};
    ...
    UE.plugins["keystrokes"] = function () {
        var me = this, flag = 0, keys = domUtils.keys, trans = {
            "B": "strong",
            "I": "em",
            "FONT": "span"
        }, sizeMap = [0, 10, 12, 16, 18, 24, 32, 48], listStyle = {
        ...
        me.addListener("keyup", function (type, evt) {
            ...
            if (!browser.gecko && !keys[keyCode] && !evt.ctrlKey && !evt.metaKey && !evt.shiftKey && !evt.altKey) {
                range = me.selection.getRange();
                if (range.collapsed) {
                    var start = range.startContainer, isFixed = 0;
    ...
    UE.plugins["autoheight"] = function () {
        ...
        var bakOverflow, span, tmpNode, lastHeight = 0, currentHeight, timer;
        ...
        me.commands["highlightcode"] = {
            execCommand: function (cmdName, code, syntax) {
                if (code && syntax) {
                    ...
                    var range = this.selection.getRange(), start = domUtils.findParentByTagName(range.startContainer, "table", true), end = domUtils.findParentByTagName(range.endContainer, "table", true), codediv;
    ...
    UE.plugins["serialize"] = function () {
        ...
        var me = this, autoClearEmptyNode = me.options.autoClearEmptyNode, EMPTY_TAG = dtd.$empty, parseHTML = function () {
            var RE_PART = /<(?:(?:\/([^>]+)>)|(?:!--([\S|\s]*?)-->)|(?:([^\s\/>]+)\s*((?:(?:"[^"]*")|(?:'[^']*')|[^"'<>])*)\/?>))/g, RE_ATTR = /([\w\-:.]+)(?:(?:\s*=\s*(?:(?:"([^"]*)")|(?:'([^']*)')|([^\s>]+)))|(?=\s|$))/g, EMPTY_ATTR = {
                ...
                readonly: 1,
                selected: 1
            }, CDATA_TAG = {script: 1, style: 1}, NEED_PARENT_TAG = {
                "li": {"$": "ul", "ul": 1, "ol": 1},
                "dd": {"$": "dl", "dl": 1},
                "dt": {"$": "dl", "dl": 1},
        ...
        var toHTML = function () {
            ...
            var transHtml = {"div": "p", "li": "p", "tr": "p", "br": "br", "p": "p"};
        ...
        var transformWordHtml = function () {
            ...
            function filterPasteWord(str) {
                str = str.replace(/<!--\s*EndFragment\s*-->[\s\S]*$/, "").replace(/^(\r\n|\n|\r)|(\r\n|\n|\r)$/ig, "").replace(/^\s*(&nbsp;)+/ig, "").replace(/(&nbsp;|<br[^>]*>)+\s*$/ig, "").replace(/<!--[\s\S]*?-->/ig, "").replace(/<v:shape [^>]*>[\s\S]*?.<\/v:shape>/gi, function (str) {
                    if (browser.opera) {
                        return "";
                    }
                    try {
                ...
                }).replace(/v:\w+=["']?[^'"]+["']?/g, "").replace(/<(!|script[^>]*>.*?<\/script(?=[>\s])|\/?(\?xml(:\w+)?|xml|meta|link|style|\w+:\w+)(?=[\s\/>]))[^>]*>/gi, "").replace(/<p [^>]*class="?MsoHeading"?[^>]*>(.*?)<\/p>/gi, "<p><strong>$1</strong></p>").replace(/(lang)\s*=\s*([\'\"]?)[\w-]+\2/ig, "").replace(/<font[^>]*>\s*<\/font>/gi, "").replace(/class\s*=\s*["']?(?:(?:MsoTableGrid)|(?:MsoListParagraph)|(?:MsoNormal(Table)?))\s*["']?/gi, "");
        ...
        var first, parentTag = "", liStyle = "", firstTag;
            ...
            switch (node.tag) {
                ...
                case"li":
                    ...
                    if (!child || child.type != "element" || child.tag != "p" && dtd.p[child.tag]) {
                        var tmpPNode = {type: "element", tag: "p", attributes: {}, parent: node};
                        tmpPNode.children = child ? node.children : [browser.ie ? {
                            type: "text",
                            data: domUtils.fillChar,
                            parent: tmpPNode
                        } : {type: "element", tag: "br", attributes: {}, closed: true, children: [], parent: tmpPNode}];
            ...
            switch (node.tag) {
                ...
                case"th":
                    ...
                    if (ie && !node.children.length) {
                        var txtNode = {type: "text", data: domUtils.fillChar, parent: node};
        ...
        Serialize.prototype = {
            rules: null, filter: function (node, rules, modify) {
    ...
    UE.plugins["table"] = function () {
        var me = this, keys = domUtils.keys, clearSelectedTd = domUtils.clearSelectedArr;
        ...
        me.commands["inserttable"] = {
            queryCommandState: function () {
                ...
                reset();
                if (opt.align) {
                    var range = me.selection.getRange(), bk = range.createBookmark(), start = range.startContainer;
        ...
        me.commands["edittable"] = {
            queryCommandState: function () {
                ...
                var start = me.selection.getStart(), table = domUtils.findParentByTagName(start, "table", true);
                if (table) {
        ...
        me.commands["edittd"] = {
            queryCommandState: function () {
                ...
                var range = this.selection.getRange(), tds = !me.currentSelectedArr.length ? [domUtils.findParentByTagName(range.startContainer, ["td", "th"], true)] : me.currentSelectedArr;
                for (var i = 0, td; td = tds[i++];) {
        ...
        me.commands["mergecells"] = {
            queryCommandState: function () {
                ...
                var start = me.currentSelectedArr[0], end = me.currentSelectedArr[me.currentSelectedArr.length - 1], table = domUtils.findParentByTagName(start, "table"), rows = table.rows, cellsRange = {
                ...
                }, beginRowIndex = cellsRange.beginRowIndex, beginCellIndex = cellsRange.beginCellIndex, rowsLength = cellsRange.endRowIndex - cellsRange.beginRowIndex + 1, cellLength = cellsRange.endCellIndex - cellsRange.beginCellIndex + 1, tmp = rows[beginRowIndex].cells[beginCellIndex];
    ...
    UE.plugins["contextmenu"] = function () {
        var me = this, lang = me.getLang("contextMenu"), menu, items = me.options.contextMenu || [{
                ...
                label: lang.cleardoc, cmdName: "cleardoc", exec: function () {
                ...
                subMenu: [{
                    ...
                    cmdName: "justify",
                    value: "center"
                }, {label: me.getLang("justify"), cmdName: "justify", value: "justify"}]
            }, "-", {
                label: lang.edittable, cmdName: "edittable", exec: function () {
                    this.ui._dialogs["inserttableDialog"].open();
                }
            }, {
                label: lang.edittd, cmdName: "edittd", exec: function () {
                    if (UE.ui["edittd"]) {
                ...
                group: lang.table,
                icon: "table",
                subMenu: [{label: lang.deletetable, cmdName: "deletetable"}, {
                    ...
                    cmdName: "splittocols"
                }, {label: lang.mergecells, cmdName: "mergecells"}, {label: lang.splittocells, cmdName: "splittocells"}]
            }, {
                label: lang["copy"], cmdName: "copy", exec: function () {
                    alert(lang.copymsg);
                }, query: function () {
                    return 0;
                }
        ...
        me.addListener("contextmenu", function (type, evt) {
                ...
                (function (item) {
                    if (item == "-") {
                        ...
                        if (item.hasOwnProperty("group")) {
                            ...
                            if ((me.commands[item.cmdName] || UE.commands[item.cmdName] || item.query) && (item.query ? item.query() : me.queryCommandState(item.cmdName)) > -1) {
            ...
            menu = new UE.ui.Menu({items: contextItems, editor: me});
            menu.render();
            menu.showAt(offset);
            domUtils.preventDefault(evt);
            if (browser.ie) {
    ...
    UE.plugins["customstyle"] = function () {
        ...
        me.setOpt({
            "customstyle": [{
                ...
                tag: "span",
                name: "im",
                style: "font-size:16px;font-style:italic;font-weight:bold;color:#000;line-height:18px;"
            }, {
                tag: "span",
                name: "hi",
        ...
        me.commands["customstyle"] = {
            execCommand: function (cmdName, obj) {
                ...
                var parent = utils.findNode(this.selection.getStartElementPath(), null, function (node) {
                    return node.getAttribute("label");
                });
                        ...
                        for (var i = 0, ci; ci = imgs[i++];) {
                            ...
                            for (var j = 0, cj; cj = srcUrls[j++];) {
                                ...
                                if (src == cj && url != "error") {
                                    ...
                                    domUtils.setAttributes(ci, {"src": newSrc, "data_ue_src": newSrc});
                                    break;
                                }
                            }
                        }
    ...
    UE.commands["snapscreen"] = {
        execCommand: function () {
            ...
            me.setOpt({snapscreenServerPort: 80, snapscreenImgAlign: "center"});
    ...
    (function () {
        UE.plugins["template"] = function () {
            ...
            me.addListener("click", function (type, evt) {
                var el = evt.target || evt.srcElement, range = me.selection.getRange();
    ...
    (function () {
        ...
        UIBase.prototype = {
            className: "", uiName: "", initOptions: function (options) {
                var me = this;
    ...
    (function () {
        ...
        baidu.editor.ui.Stateful = {
            alwalysHoverable: false, Stateful_init: function () {
    ...
    (function () {
        ...
        AutoTypeSetPicker.prototype = {
            initAutoTypeSetPicker: function () {
                ...
                return '<div id="##" class="edui-autotypesetpicker %%">' + '<div class="edui-autotypesetpicker-body">' + "<table >" + '<tr><td colspan="2"><input type="checkbox" name="mergeEmptyline" ' + (opt["mergeEmptyline"] ? "checked" : "") + ">" + lang.mergeLine + '</td><td colspan="2"><input type="checkbox" name="removeEmptyline" ' + (opt["removeEmptyline"] ? "checked" : "") + ">" + lang.delLine + "</td></tr>" + '<tr><td colspan="2"><input type="checkbox" name="removeClass" ' + (opt["removeClass"] ? "checked" : "") + ">" + lang.removeFormat + '</td><td colspan="2"><input type="checkbox" name="indent" ' + (opt["indent"] ? "checked" : "") + ">" + lang.indent + "</td></tr>" + '<tr><td colspan="2"><input type="checkbox" name="textAlign" ' + (opt["textAlign"] ? "checked" : "") + ">" + lang.alignment + '</td><td colspan="2" id="textAlignValue"><input type="radio" name="textAlignValue" value="left" ' + ((opt["textAlign"] && opt["textAlign"] == "left") ? "checked" : "") + ">" + me.getLang("justifyleft") + '<input type="radio" name="textAlignValue" value="center" ' + ((opt["textAlign"] && opt["textAlign"] == "center") ? "checked" : "") + ">" + me.getLang("justifycenter") + '<input type="radio" name="textAlignValue" value="right" ' + ((opt["textAlign"] && opt["textAlign"] == "right") ? "checked" : "") + ">" + me.getLang("justifyright") + " </tr>" + '<tr><td colspan="2"><input type="checkbox" name="imageBlockLine" ' + (opt["imageBlockLine"] ? "checked" : "") + ">" + lang.imageFloat + "</td>" + '<td colspan="2" id="imageBlockLineValue">' + '<input type="radio" name="imageBlockLineValue" value="none" ' + ((opt["imageBlockLine"] && opt["imageBlockLine"] == "none") ? "checked" : "") + ">" + me.getLang("default") + '<input type="radio" name="imageBlockLineValue" value="left" ' + ((opt["imageBlockLine"] && opt["imageBlockLine"] == "left") ? "checked" : "") + ">" + me.getLang("justifyleft") + '<input type="radio" name="imageBlockLineValue" value="center" ' + ((opt["imageBlockLine"] && opt["imageBlockLine"] == "center") ? "checked" : "") + ">" + me.getLang("justifycenter") + '<input type="radio" name="imageBlockLineValue" value="right" ' + ((opt["imageBlockLine"] && opt["imageBlockLine"] == "right") ? "checked" : "") + ">" + me.getLang("justifyright") + "</tr>" + '<tr><td colspan="2"><input type="checkbox" name="clearFontSize" ' + (opt["clearFontSize"] ? "checked" : "") + ">" + lang.removeFontsize + '</td><td colspan="2"><input type="checkbox" name="clearFontFamily" ' + (opt["clearFontFamily"] ? "checked" : "") + ">" + lang.removeFontFamily + "</td></tr>" + '<tr><td colspan="4"><input type="checkbox" name="removeEmptyNode" ' + (opt["removeEmptyNode"] ? "checked" : "") + ">" + lang.removeHtml + "</td></tr>" + '<tr><td colspan="4"><input type="checkbox" name="pasteFilter" ' + (opt["pasteFilter"] ? "checked" : "") + ">" + lang.pasteFilter + "</td></tr>" + '<tr><td colspan="4" align="right"><button >' + lang.run + "</button></td></tr>" + "</table>" + "</div>" + "</div>";
            }, _UIBase_render: UIBase.prototype.render
        };
    ...
    (function () {
        var utils = baidu.editor.utils, domUtils = baidu.editor.dom.domUtils, uiUtils = baidu.editor.ui.uiUtils, UIBase = baidu.editor.ui.UIBase, Popup = baidu.editor.ui.Popup, Stateful = baidu.editor.ui.Stateful, Menu = baidu.editor.ui.Menu = function (options) {
            this.initOptions(options);
            this.initMenu();
        };
        var menuSeparator = {
    ...
    (function () {
        ...
        Combox.prototype = {
            uiName: "combox", initCombox: function () {
                ...
                this.popup = new Menu({items: this.items, uiName: "list", editor: this.editor});
                this.initSplitButton();
            }, _SplitButton_postRender: SplitButton.prototype.postRender, postRender: function () {
                this._SplitButton_postRender();
    ...
    (function () {
        var utils = baidu.editor.utils, domUtils = baidu.editor.dom.domUtils, uiUtils = baidu.editor.ui.uiUtils, Mask = baidu.editor.ui.Mask, UIBase = baidu.editor.ui.UIBase, Button = baidu.editor.ui.Button, Dialog = baidu.editor.ui.Dialog = function (options) {
            this.initOptions(utils.extend({
                autoReset: true, draggable: true, onok: function () {
                }, oncancel: function () {
        ...
        var dragMask;
        Dialog.prototype = {
            draggable: false, uiName: "dialog", initDialog: function () {
                var me = this;
                this.initUIBase();
                this.modalMask = (modalMask || (modalMask = new Mask({className: "edui-dialog-modalmask"})));
                this.dragMask = (dragMask || (dragMask = new Mask({className: "edui-dialog-dragmask"})));
    ...
    (function () {
        ...
        var dialogBtns = {
            ...
            ok: ["attachment", "anchor", "link", "insertimage", "map", "gmap", "insertframe", "wordimage", "insertvideo", "highlightcode", "insertframe", "edittd", "scrawl", "template", "background"]
        };
        ...
        editorui.snapscreen = function (editor, iframeUrl, title) {
            ...
            var ui = new editorui.Button({
                className: "edui-for-snapscreen", title: title, onclick: function () {
            ...
            if (browser.ie) {
                ...
                if (iframeUrl) {
                    var dialog = new editorui.Dialog({
                        ...
                        title: title,
                        buttons: [{
                            className: "edui-okbutton", label: editor.getLang("ok"), onclick: function () {
                                dialog.close(true);
                            }
                        }, {
                            className: "edui-cancelbutton", label: editor.getLang("cancel"), onclick: function () {
                                dialog.close(false);
                            }
                        }]
                    });
        ...
        editorui.fontfamily = function (editor, list, title) {
            ...
            for (var i = 0, ci, items = []; ci = list[i]; i++) {
                ...
                (function (key, val) {
                    items.push({
                        label: key, value: val, renderLabelHtml: function () {
            ...
            var ui = new editorui.Combox({
                editor: editor, items: items, onselect: function (t, index) {
        ...
        editorui.fontsize = function (editor, list, title) {
            ...
            for (var i = 0; i < list.length; i++) {
                var size = list[i] + "px";
                items.push({
                    label: size, value: size, renderLabelHtml: function () {
        ...
        editorui.paragraph = function (editor, list, title) {
            ...
            for (var i in list) {
                items.push({
                    value: i, label: list[i] || editor.getLang("paragraph")[i], renderLabelHtml: function () {
        ...
        editorui.customstyle = function (editor) {
            ...
            for (var i = 0, items = [], t; t = list[i++];) {
                (function (t) {
                    ...
                    ck.tag = t.tag;
                    items.push({
                        label: ck.label, value: ck, renderLabelHtml: function () {
        ...
        editorui.lineheight = function (editor) {
            ...
            for (var i = 0, ci, items = []; ci = val[i++];) {
                items.push({
                    label: ci, value: ci, onclick: function () {
        ...
        for (var l = 0, cl; cl = lists[l++];) {
            (function (cmd) {
                editorui[cmd] = function (editor) {
                    ...
                    for (var i in vals) {
                        items.push({label: vals[i] || editor.getLang()[cmd][i] || "", value: i, onclick: _onMenuClick});
                    }
                    var ui = new editorui.MenuButton({
                        editor: editor,
                        className: "edui-for-" + cmd,
        ...
        editorui.fullscreen = function (editor, title) {
            ...
            var ui = new editorui.Button({
                className: "edui-for-fullscreen", title: title, onclick: function () {
                    if (editor.ui) {
            ...
            uiName: "editor", initEditorUI: function () {
                ...
                if (editor.options.imagePopup) {
                    ...
                    editor.addListener("selectionchange", function (t, causeByUi) {
                        ...
                        var html = "", img = editor.selection.getRange().getClosedNode(), dialogs = editor.ui._dialogs;
                        if (img && img.tagName == "IMG") {
        ...
        baidu.editor.ui.Editor = function (options) {
            ...
            editor.render = function (holder) {
                utils.domReady(function () {
                    ...
                    function renderUI() {
                        editor.setOpt({labelMap: editor.options.labelMap || UE.I18N[editor.options.lang].labelMap});
    ...
    (function () {
        ...
        MultiMenuPop.prototype = {
            initMultiMenu: function () {
                var me = this;
                this.popup = new Popup({
                    content: "", editor: me.editor, iframe_rendered: false, onshow: function () {
