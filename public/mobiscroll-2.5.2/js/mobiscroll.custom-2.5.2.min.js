        ...
        o.show = function (j) {
            ...
            for (var d = '<div class="dw-trans ' + p.theme + " dw-" + p.display + '">' + ("inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp"><div class="dwo"></div><div class="dw dwbg ' + f + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (p.headerText ? '<div class="dwv"></div>' : "")), j = 0; j < p.wheels.length; j++) {
                ...
                for (e in p.wheels[j])$[b] = p.wheels[j][e], d += '<td><div class="dwwl dwrc dwwl' + b + '">' + ("scroller" != p.mode ? '<div class="dwwb dwwbp" style="height:' + N + "px;line-height:" + N + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + N + "px;line-height:" + N + 'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' + e + '</div><div class="dww" style="height:' + p.rows * N + "px;min-width:" +
                    p.width + 'px;"><div class="dw-ul">', d += m(b), d += '</div><div class="dwwo"></div></div><div class="dwwol"></div></div></td>', b++;
                d += "</tr></table></div></div>"
            }
...
(function (a) {
    var t = a.mobiscroll, k = new Date, n = {
        ...
        if (y.match(/time/i)) {
            ...
            } else i == r.a && (s++, y = v.match(/A/), g[f.ampmText] = {"0": y ? "AM" : "am", 1: y ? "PM" : "pm"});
            A.push(g)
        }
        k.setDate = function (a, b, c, d) {
            for (var e in r)this.temp[r[e]] = a[w[e]] ? a[w[e]]() : w[e](a);
        ...
        return {
            ...
            headerText: function () {
                ...
                for (c in r)d[r[c]] = b[w[c]] ? b[w[c]]() : w[c](b);
                return d
            }, validate: function (c) {
                var g = k.temp, i = {y: G.getFullYear(), m: 0, d: 1, h: 0, i: 0, s: 0, a: 0}, h = {
                    y: M.getFullYear(),
                    m: 11,
                    d: 31,
                    h: l(D ? 11 : 23, b),
    ...
    t.parseDate = function (k, u, l) {
        ...
        var u = "object" == typeof u ? u.toString() : u + "", g = a.extend({}, n, l), t = g.shortYearCutoff, l = m.getFullYear(), q = m.getMonth() + 1, i = m.getDate(), f = -1, s = m.getHours(), m = m.getMinutes(), A = 0, r = -1, h = !1, w = function (a) {
            ...
            y = function (a) {
                ...
                a = w(a) ? f : g;
                for (g = 0; g < a.length; g++)if (u.substr(v, a[g].length).toLowerCase() == a[g].toLowerCase())return v += a[g].length, g + 1;
                return 0
            }, v = 0, x;
...
(function (a) {
    var t = a.mobiscroll, k = {invalid: [], showInput: !0, inputClass: ""}, n = function (n) {
        function t(g, c, b, e) {
            for (var d = 0; d < c;) {
...
(function (a) {
    var t = {inputClass: "", invalid: [], rtl: !1, group: !1, groupLabel: "Groups"};
    ...
    a.mobiscroll.presets.select = function (k) {
        ...
        function O(a, b) {
            ...
            if (g) {
                var d = [], f = 0;
                for (f in k._selectedValues)d.push(C[f]), e.push(f);
                D.val(d.join(", "))
...
(function (a) {
    ...
    a.mobiscroll.themes.wp = {
        defaults: {
            width: 70, height: 76, accent: "none", dateOrder: "mmMMddDDyy", onAnimStart: function (k, n, A) {
