    ...
    <div class="left_nav">
        <div class="operate">
            <ul id="juheweb">
                ...
                %>
                <li>
                    <h4 <%=getDoc.getIn("course_id") == course_json.optInt("id") ? "class=\"selected\"" : ""%>><%=course_json.optString("name")%>
                    </h4>
                    <div class="list-item<%=getDoc.getIn("course_id")==course_json.optInt("id")?"":" none"%>">
                        ...
                        %>
                        <p <%=chapter_id == chapter_json.optInt("id") ? "class=\"on\"" : ""%>><a
                                href="teaching_resources.jsp?chapter_id=<%=chapter_json.optInt("id")%>"><%=chapter_json.optString("name")%>
                        </a></p>
                        <%
                                }
                            }
