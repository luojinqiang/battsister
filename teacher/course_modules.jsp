                ...
                <div class="one_img"><img src="<%=course_json.optString("pic")%>"></div>
                	<div class="one_word">
                 	 <h3><%=course_json.optString("name")%></h3>
						...
						<div class="botton1"><a href="../pdf/web/viewer.html?file=<%=BasicType.getValueByKey(course_json.optString("teaching_guide"), "word_dir")%>" target="_blank" style="background-color:#fd7700;">教学指南</a></div>
						<div class="botton1"><a href="../pdf/web/viewer.html?file=<%=BasicType.getValueByKey(course_json.optString("teaching_evalution"), "word_dir")%>" target="_blank" style="background-color:#fd7700;">教学评价</a></div>
						<div class="botton1"><a href="../pdf/web/viewer.html?file=<%=BasicType.getValueByKey(course_json.optString("teaching_plan"), "word_dir")%>" target="_blank" style="background-color:#fd7700;">课程标准</a></div>
                </div>
                <div class="clear"></div>
           </div>	
           		<%
