...
<div class="topbg">
    ...
    <!-- 	<div class="top_img"><img src="/front_style/images/user02.png"></div> -->
        <div class="top_word">
            ...
            <div class="xuehao">账号：<%=session.getAttribute("username")%><a href="personal.jsp">修改个人资料</a><a href="using_instructions.jsp">平台使用手册</a><span>上次登录时间：<%=object!=null?object.toString():"首次登录"%></span></div>
        </div>
        <div class="clear"></div>
    </div>
</div>