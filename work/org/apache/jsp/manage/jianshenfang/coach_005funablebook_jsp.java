 ...
 * Generated at: 2015-12-10 07:34:29 UTC
...
public final class coach_005funablebook_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/jianshenfang/../left.jsp", Long.valueOf(1449539681511L));
...
return;
    ...
    if (action.equals("del")) {
        coachUnablebook coachUnablebook = new coachUnablebook();
        out.print(coachUnablebook.delcoachUnablebook(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    int id = ru.getInt("id");
    int coach_id = ru.getInt("coach_id");
    Doc coach_Doc=utildb.Get_Doc("id,coach_name","hy_coach"," where id=? and isdel=0 ","mysqlss",new Object[]{coach_id});
	if(coach_Doc==null||coach_Doc.isEmpty()){
		out.print("教练不存在");
		return;
	}
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"coach_unablebook.jsp\",\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function addBook(id, title) {\r\n");
      out.write("            openurl('coach_unablebook_edit.jsp?id=' + id + '&coach_id=");
      out.print(coach_id);
      out.write("', 'user', title, 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("    <strong>");
      out.print(coach_Doc.get("coach_name",""));
      out.write("教练排班列表</strong>\r\n");
      out.write("    </div>\r\n");
      out.write("    <div class=\"btnitem mb10 clearfix\">\r\n");
      out.write("        <ul class=\"s_btn\">\r\n");
      out.write("            <li><a href=\"javascript:addBook(0,'新增教练排班')\">新增教练排班</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                    <th width=\"14%\">教练名称</th> -->\r\n");
      out.write("                    <th width=\"12%\">不能预约时间</th>\r\n");
      out.write("                   \t<th width=\"10%\">类型</th>\r\n");
      out.write("                   \t<th width=\"15%\">备注</th>\r\n");
      out.write("                    <th width=\"12%\">创建时间</th>\r\n");
      out.write("                    <th width=\"8%\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table2 = "hy_coach_unablebook a ";
                    String wheres2 = "where a.isdel=0 and a.coach_id=?";
                    List list2 = new ArrayList();
                    list2.add(coach_id);//把coach_id添加到List
                    String file2 = "a.id,a.unable_type,a.unable_book_time,a.title,a.remark,a.create_time";
                    List list = utildb.Get_List(file2, table2, wheres2, "mysqlss", list2);
                    if (list != null) {
      ...
      out.write("\r\n");
      out.write("                    <td>");
      out.print(doc2.getIn("unable_book_time") != 0 ? AjaxXml.timeStamp2Date(doc2.getIn("unable_book_time"), "YY04-MM-DD HH:00") : "" );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");

                    	if(doc2.getIn("unable_type")==0){
                    		out.print("其他");
                    	}else if(doc2.getIn("unable_type")==1){
                    		out.print("自我锻炼");
                    	}else if(doc2.getIn("unable_type")==2){
                    		out.print("私人事件");
                    	}
      ...
      out.write("                    <td>\r\n");
      out.write("                    ");
      out.print(doc2.get("remark","") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc2.getIn("create_time") != 0 ? AjaxXml.timeStamp2Date(doc2.getIn("create_time"), "YY04-MM-DD HH:MI:SS") : "" );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <a href=\"javascript:addBook(");
      out.print(doc2.get("id"));
      out.write(",'编辑教练排班')\">编辑</a>\r\n");
