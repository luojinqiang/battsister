 ...
 * Generated at: 2015-12-25 09:30:02 UTC
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",3009,") < 0) {
    ...
    if (action.equals("del")) {
        ...
        out.print(groupApi.delCoach(request, userid, user_name,
                gym_group_id, gym_id).toString());
        return;
    }
    if (action.equals("batchDel")) {
        GroupAPI groupApi = new GroupAPI();
        out.print(groupApi.batchDelCoach(request, userid, user_name,
                gym_group_id, gym_id).toString());
        return;

    }
    if (action.equals("changeOn")) {
        GroupAPI groupApi = new GroupAPI();
        out.print(groupApi.changeOnOfCoach(request, userid, user_name,
                gym_group_id, gym_id));
        return;
    }
    ...
    //String coach_name = new String(ru.getString("coach_name", "").getBytes("ISO-8859-1"), "utf-8");
    String coach_name = ru.getString("coach_name");
    int is_on = ru.getInt("is_on", -1);
    //String specialty = new String(ru.getString("specialty", "").getBytes("ISO-8859-1"), "utf-8");
    String specialty = ru.getString("specialty");
    //String profession = new String(ru.getString("profession", "").getBytes("ISO-8859-1"), "utf-8");
    String profession = ru.getString("profession");
    //String login_name = new String(ru.getString("login_name", "").getBytes("ISO-8859-1"), "utf-8");
    String login_name = ru.getString("login_name");
    //String coach_mobile = new String(ru.getString("coach_mobile", "").getBytes("ISO-8859-1"), "utf-8");
    String coach_mobile = ru.getString("coach_mobile");
    int gymGroupId = ru.getInt("gymGroupId");
    int gymId = ru.getInt("gymId");
    int coach_grade = ru.getInt("coach_grade");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function coach_edit(id, title) {\r\n");
      out.write("            openurl('coach_edit.jsp?id=' + id + '', 'order', title, 850, 500, 0, 10,\r\n");
      out.write("                    true);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        /**\r\n");
      out.write("         * 更改教练状态\r\n");
      out.write("         */\r\n");
      out.write("        function is_on(type, id) {\r\n");
      out.write("            art.dialog({\r\n");
      out.write("                id: 'changeID',\r\n");
      out.write("                content: '确定更改？',\r\n");
      out.write("                lock: true,\r\n");
      out.write("                button: [{\r\n");
      out.write("                    name: '确定',\r\n");
      out.write("                    callback: function () {\r\n");
      ...
      out.write("                            type: \"post\",\r\n");
      out.write("                            url: \"coach.jsp\",\r\n");
      out.write("                            data: \"action=changeOn&id=\" + id + \"&is_on=\" + type,\r\n");
      out.write("                            success: function (msg) {\r\n");
      out.write("                                art.dialog({\r\n");
      out.write("                                    id: 'tisID'\r\n");
      out.write("                                }).close();\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("\r\n");
      out.write("                <li>教练名：<input type=\"text\" name=\"coach_name\" value=\"");
      out.print(coach_name);
      out.write("\"/></li>\r\n");
      out.write("                <li>专业：<input type=\"text\" name=\"specialty\" value=\"");
      out.print(specialty);
      out.write("\"/></li>\r\n");
      out.write("                <li>职业：<input type=\"text\" name=\"profession\" value=\"");
      out.print(profession);
      out.write("\"/></li>\r\n");
      out.write("                <li>登入账号：<input type=\"text\" name=\"login_name\" value=\"");
      out.print(login_name);
      out.write("\"/></li>\r\n");
      out.write("            </ul>\r\n");
      out.write("            <ul class=\"row3\" style=\"margin-top: 3px;\">\r\n");
      out.write("                <li>手机号码：<input type=\"text\" name=\"coach_mobile\" value=\"");
      ...
      out.write("            <li><a href=\"javascript:coach_edit(0,'新增教练')\">新增教练</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                    <th width=\"12%\">姓名</th>\r\n");
      out.write("                    <th width=\"14%\">所属连锁</th>\r\n");
      out.write("                    <th width=\"14%\">所属健身房</th>\r\n");
      out.write("                    <th width=\"10%\">当前等级</th>\r\n");
      out.write("                  <!--   <th width=\"5%\">状态</th> -->\r\n");
      out.write("                  <!--   <th width=\"10%\">预约数</th> -->\r\n");
      out.write("                    <th width=\"10%\">专业</th>\r\n");
      out.write("                    <!-- <th width=\"10%\">职业</th> -->\r\n");
      out.write("                  <!--   <th width=\"10%\">登入账号</th> -->\r\n");
      out.write("                    <th width=\"14%\">手机号码</th>\r\n");
      out.write("                    <th>操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_coach a left join hy_gym_group b on a.gym_group_id=b.id left join hy_gym c on a.gym_id=c.id";
                    ...
                    if (!"".equals(coach_name)) {
                        sb.append(" and a.coach_name like ? ");
                        sqllist.add("%" + coach_name + "%");
                    }
                    if (coach_grade > 0) {
                        sb.append(" and a.coach_grade=? ");
                        sqllist.add(coach_grade);
                    }
                    if (is_on == 0) {
                        sb.append(" and a.is_on=0");
                    }
                    if (is_on == 1) {
                        sb.append(" and a.is_on=1");
                    }
                    if (!("").equals(specialty)) {
                        sb.append(" and a.specialty like ?");
                        sqllist.add("%" + specialty + "%");
                    }
                    if (!("").equals(profession)) {
                        sb.append(" and a.profession like ?");
                        sqllist.add("%" + profession + "%");
                    }
                    if (!("").equals(login_name)) {
                        sb.append(" and a.login_name like ?");
                        sqllist.add("%" + login_name + "%");
                    }
                    if (!("").equals(coach_mobile)) {
                        sb.append(" and a.coach_mobile like ?");
                        sqllist.add("%" + coach_mobile + "%");
                    }
                    int i = 1;
                    String file = "a.id,a.coach_grade,a.order_times,a.coach_name,a.is_on, "
                            + "a.specialty,a.profession,a.login_name,a.coach_mobile,b.group_name,c.gym_name";
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(BasicType.getCoach_grade(doc.getIn("coach_grade")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                   ");
      out.write("\r\n");
      ...
      out.write("                    <td>");
                    	...
                    	if(doc.get("specialty")!=null&&!"".equals(doc.get("specialty"))){
                    		JSONArray array=JSONArray.fromObject(doc.get("specialty"));
                    		if(array!=null){
                    			for(int j=0;j<array.size();j++){
                    				if(j!=array.size()-1){
                    					out.print(array.optJSONObject(j).optString("type_name")+",");
                    				}else{
                    					out.print(array.optJSONObject(j).optString("type_name"));
                    				}
                    			}
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("coach_mobile", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <a href=\"javascript:coach_edit(");
      out.print(doc.get("id"));
      out.write(",'编辑教练')\">编辑/详细</a>&nbsp;&nbsp;\r\n");
      out.write("                        <a\r\n");
      out.write("                                href=\"javascript:window.parent.jianyi2('jianshenfang/coach_unablebook.jsp?coach_id=");
      out.print(doc.get("id"));
      out.write("','排班')\">排班</a>&nbsp;&nbsp;\r\n");
      ...
      out.write("                               onclick=\"CheckAll(this.form);\"/>\r\n");
      out.write("                        选中/取消所有\r\n");
      out.write("                    </td>\r\n");
