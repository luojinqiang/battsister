 ...
 * Generated at: 2015-12-25 08:40:09 UTC
...
public final class gym_005fmember_005fbook_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    if (action.equals("del")) {
        ...
        out.print(deviceApi.delDeviceType(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    if (action.equals("batchDel")) {
        DeviceAPI deviceApi = new DeviceAPI();
        out.print(deviceApi.batchDelDeviceType(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    ...
    int book_status = ru.getInt("book_status");
      ...
      out.write("                            type: \"post\",\r\n");
      out.write("                            url: \"gymDeviceTypeList.jsp\",\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function serviceShop_edit(id, title) {\r\n");
      out.write("            openurl('gym_service_shop_edit.jsp?id=' + id, 'order', title, 700, 380, 0,\r\n");
      out.write("                    10, true);\r\n");
      out.write("        }\r\n");
      out.write("        function changeBookStatus(id,status){//改变预约的状态\r\n");
      out.write("        \topenurl('gym_member_book_status.jsp?id='+id+'&v_status='+status+'','version','会员预约状态更改',200,100,0,10,true);\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("        <strong>用户预约健身房消费服务列表</strong>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                </li>\r\n");
      out.write("                <li>会员账号：\r\n");
      out.write("                    <input name=\"mem_username\" type=\"text\" id=\"mem_username\" value=\"");
      out.print(mem_username);
      out.write("\"\r\n");
      out.write("                           style=\"width: 100px;\"/></li>\r\n");
      out.write("                <li>预约状态：\r\n");
      out.write("                    <select name=\"book_status\" id=\"book_status\">\r\n");
      ...
      out.print(doc.getIn("id")+1);
      out.write('"');
      out.write(' ');
      out.print((book_status == (doc.getIn("id")+1)? "selected" : ""));
      out.write('>');
      ...
      out.write("                    <th width=\"10%\">教练名称</th>\r\n");
      out.write("                    <th width=\"12%\">预约时间</th>\r\n");
      out.write("                    <th width=\"10%\">预约状态</th>\r\n");
      out.write("                    <th width=\"12%\">添加时间</th>\r\n");
      out.write("                     <th width=\"\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_member_book_coach a left join hy_gym_group b on a.gym_group_id=b.id left join hy_gym c on a.gym_id=c.id"
                            + " left join hy_member m on a.mem_userid=m.id left join hy_coach d on a.coach_id=d.id";
                    ...
                    if (!"".equals(mem_name)) {
                        sb.append(" and m.mem_name like ?");
                        sqllist.add("%" + URLEncoder.encode(mem_name, "utf-8") + "%");
                    }
                    if (!"".equals(mem_username)) {
                        sb.append(" and m.mem_username like ?");
                        sqllist.add("%" + mem_username + "%");
                    }
                    if(book_status>0){
                    	sb.append(" and a.book_status=? ");
                    	sqllist.add(book_status-1);
                    }
                    String file = "a.id,a.book_status,a.book_time,a.create_time, "
                            + " b.group_name,c.gym_name,m.mem_username,m.mem_name,d.coach_name";
      ...
      out.write("                    <th width=\"10%\">所属健身房</th>\r\n");
      out.write("                    <th width=\"8%\">会员名称</th>\r\n");
      out.write("                    <th width=\"10%\">教练名称</th>\r\n");
      out.write("                    <th width=\"12%\">预约时间</th>\r\n");
      out.write("                    <th width=\"6%\">预约状态</th>\r\n");
      ...
      out.write("                    </td>\r\n");
      out.write("                     <td>");
      out.print(doc.getIn("book_time") != 0 ? AjaxXml.timeStamp2Date(doc.getIn("book_time"), "YY04-MM-DD HH:00") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                    \t");
out.print("<a href=\"javascript:changeBookStatus('"+doc.get("id")+"','"+doc.get("book_status")+"')\">"+BasicType.getBookStatus(doc.getIn("book_status"))+"</a> ");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                     <td>");
      out.print(doc.getIn("book_time") != 0 ? AjaxXml.timeStamp2Date(doc.getIn("book_time"), "YY04-MM-DD HH:MI:SS") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                       ");
      ...
      out.write("                    ");
      out.write("\r\n");
      out.write("                    <td colspan=\"9\" style=\"text-align: right\">\r\n");
      out.write("                        ");
      out.write("\r\n");
      out.write("                        ");
