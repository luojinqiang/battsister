 ...
 * Generated at: 2015-12-25 06:00:24 UTC
...
public final class device_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/jianshenfang/../left.jsp", Long.valueOf(1450850572828L));
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",3045,") < 0) {
    ...
    if (action.equals("del")) {
        ...
        out.print(deviceApi.delDevice(request, userid, user_name, gym_group_id, gym_id));
        return;
    }
    if (action.equals("batchDel")) {
        DeviceAPI deviceApi = new DeviceAPI();
        out.print(deviceApi.batchDelDevice(request, userid, user_name, gym_group_id, gym_id));
        return;
    }
    ...
    int device_data_type = ru.getInt("device_data_type");
	/*if(device_type<=0){
	 out.print("信息不存在");
	 return ;
	 }*/
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"device.jsp\",\r\n");
      out.write("                                data: \"action=del&id=\" + id + \"&device_type\" +");
      out.print(device_type);
      out.write(",\r\n");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"device.jsp\",\r\n");
      out.write("                                data: \"action=batchDel&ids=\" + ids + \"&device_type\" +");
      out.print(device_type);
      out.write(",\r\n");
      out.write("                                success: function (msg) {\r\n");
      out.write("                                    art.dialog({id: 'tisID'}).close();\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("        function device_edit(id, title) {\r\n");
      out.write("            openurl('device_edit.jsp?id=' + id + '&device_type=");
      out.print(device_type);
      out.write("', 'order', title, 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("\r\n");
      out.write("                <li>设备类型：\r\n");
      out.write("                    <select name=\"device_type\">\r\n");
      ...
      out.write("                <li>\r\n");
      out.write("                    数据上传类型：\r\n");
      out.write("                    <select name=\"device_data_type\">\r\n");
      out.write("                        <option value=\"0\">--请选择上传数据类型--</option>\r\n");
      out.write("                        <option value=\"1\"");

                            if (device_data_type == 1) {
                                out.print("selected=\"selected\"");
                            }
      ...
      out.write("            <li>\r\n");
      out.write("                <a href=\"javascript:device_edit(0,'新增");
      out.print(BasicType.getDeviceType(device_type));
      out.write("')\">新增");
      out.print(BasicType.getDeviceType(device_type));
      out.write("\r\n");
      out.write("                </a>\r\n");
      ...
      out.write("                    <th width=\"8%\">设备名称</th>\r\n");
      out.write("                    <th width=\"12%\">所属连锁</th>\r\n");
      out.write("                    <th width=\"12%\">所属健身房</th>\r\n");
      out.write("                    <th width=\"8%\">设备类型</th>\r\n");
      out.write("                    <th width=\"8%\">数据上传类型</th>\r\n");
      out.write("                    <th width=\"12%\">设备ID</th>\r\n");
      out.write("                    <th width=\"12%\">设备MAC</th>\r\n");
      ...
      out.write("                ");
                    ...
                    String table = "hy_device a left join hy_gym_group b on a.gym_group_id=b.id left join hy_gym c on a.gym_id=c.id";
                    ...
                    if (device_type == 1) {
                        sb.append(" and a.device_type=1");
                    }
                    if (device_type == 2) {
                        sb.append(" and a.device_type=2");
                    }
                    if (device_type == 3) {
                        sb.append(" and a.device_type=3");
                    }
                    if (device_type == 4) {
                        sb.append(" and a.device_type=4");
                    }
                    if (device_type == 5) {
                        sb.append(" and a.device_type=5");
                    }
                    if (device_data_type == 1) {
                        sb.append(" and a.device_data_type=1");
                    }
                    if (device_data_type == 2) {
                        sb.append(" and a.device_data_type=2");
                    }
                    if (device_data_type == 3) {
                        sb.append(" and a.device_data_type=3");
                    }
                    int i = 1;
                    String file = "a.id,a.device_type,a.device_name,a.device_data_type, "
                            + "a.device_coding,a.device_mac,a.is_use,a.create_time,b.group_name,c.gym_name";
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(BasicType.getDeviceType(doc.getIn("device_type")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(BasicType.getDateType(doc.getIn("device_data_type")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("device_coding", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("device_mac", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                        ");

                            if (doc.getIn("is_use") == 0) {
                                out.print("在用");
                            } else {
                                out.print("不在用");
                            }
      ...
      out.write("\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <a href=\"javascript:device_edit(");
      out.print(doc.get("id"));
      out.write(",'编辑");
      out.print(BasicType.getDeviceType(device_type));
      out.write("')\">编辑/详细</a>&nbsp;&nbsp;\r\n");
