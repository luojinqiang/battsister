 ...
 * Generated at: 2015-12-10 07:35:55 UTC
...
import com.hanyou.admin.sys.coachUnablebook;
import com.hanyou.util.BasicType;
import com.baje.sz.util.*;
import com.baje.sz.ajax.*;
import com.hanyou.admin.sys.*;

public final class coach_005funablebook_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.hanyou.admin.sys.coachUnablebook");
...
return;
    ...
    if (action.equals("save")) {//更新
        ...
        out.print(coachUnablebook.addUnablebook(request, userid, user_name, gym_group_id, gym_id));
        return;
    }
    String unable_book_time = "",remark="";
    int unable_type = 0;
    if (id > 0) {
        Doc doc = utildb.Get_Doc("unable_book_time,unable_type", "hy_coach_unablebook", "where isdel=0 and id=? ", "mysqlss", new Object[]{id});
        if (doc == null) {
            out.print("信息不存在");
            return;
        } else {
            unable_book_time = doc.getIn("unable_book_time")>0?AjaxXml.timeStamp2Date(doc.getIn("unable_book_time"),"YY04-MM-DD HH:00"):unable_book_time;
            unable_type = doc.getIn("unable_type");
        }
    }
      ...
      out.write("                type: \"post\",\r\n");
      out.write("                url: \"coach_unablebook_edit.jsp\",\r\n");
      ...
      out.print(id);
      out.write("\"/>\r\n");
      out.write("            <input name=\"coach_id\" type=\"hidden\" value=\"");
      out.print(coach_id);
      out.write("\"/>\r\n");
      out.write("            <input name=\"action\" id=\"action\" type=\"hidden\" value=\"save\"/>\r\n");
      out.write("            <ul class=\"row3 clearfix\">\r\n");
      out.write("                <li>不能预约的时间：\r\n");
      out.write("                    <input name=\"unable_book_date\" type=\"text\" id=\"unable_book_date\"\r\n");
      out.write("                           value=\"");
      out.print(unable_book_time);
      out.write("\"\r\n");
      out.write("                           style=\"width:100px;\" onclick=\"SelectDate(this,'yyyy-MM-dd hh:00',0,0)\"/>\r\n");
      out.write("                </li>\r\n");
      out.write("                <li>\r\n");
      out.write("                \t标题：\r\n");
      out.write("                \t<select name=\"title\">\r\n");
      out.write("                \t\t<option value=\"0\" ");
      out.print(unable_type==0?"selected=\"selected\"":"");
      out.write(">其他</option>\r\n");
      out.write("                \t\t<option value=\"1\" ");
      out.print(unable_type==1?"selected=\"selected\"":"");
      out.write(">自我锻炼</option>\r\n");
      out.write("                \t\t<option value=\"2\" ");
      out.print(unable_type==2?"selected=\"selected\"":"");
      out.write(">私人事件</option>\r\n");
      out.write("                \t</select>\r\n");
      out.write("                </li>\r\n");
      out.write("                <li>\r\n");
      out.write("                \t备注：\r\n");
      out.write("                \t<input type=\"text\" name=\"remark\" value=\"");
      out.print(remark);
      out.write("\"/>\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
