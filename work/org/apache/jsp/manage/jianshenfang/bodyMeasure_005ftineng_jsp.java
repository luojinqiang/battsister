 ...
 * Generated at: 2016-01-05 10:03:29 UTC
...
public final class bodyMeasure_005ftineng_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",3050,") < 0) {
    ...
    int gymId = ru.getInt("gymId");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"bodyMeasure_tineng.jsp\",\r\n");
      ...
      out.write("            var measure_type = 2;\r\n");
      out.write("            window.parent.jianyi2('jianshenfang/bodyMeasure_tineng_edit.jsp?id=' + id + '&measure_type=' + measure_type + '', '体能编辑');\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("            <li><a href=\"javascript:bodyMeasure(0,'新增会员体能')\">新增会员体能</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div> -->\r\n");
      ...
      out.write("                    <th width=\"8%\">教练名</th>\r\n");
      out.write("                    <th width=\"8%\">用户名</th>\r\n");
      out.write("                    <th width=\"40%\">体能结果</th>\r\n");
      out.write("                   \t<th width=\"20%\">总结建议</th>\r\n");
      out.write("                    <th width=\"14%\">测试时间</th>\r\n");
      out.write("                    <th width=\"\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_member_measure_tineng a left join hy_member b on a.member_id=b.id  left join hy_coach e on a.coach_id=e.id ";
                  ...
                  /*   if (!"".equals(order_no)) {
                   ...
                   /*  if (order_status > 0) {
                    ...
                    int i = 1;
                    String file = "a.id,a.tice_time,a.tineng_result,a.summary," +
      ...
      out.write("                    \t");
                    		...
                    		if(doc.get("tineng_result")!=null&&!"".equals(doc.get("tineng_result") )){
                    			JSONArray result_array=JSONArray.fromObject(doc.get("tineng_result"));
                    			if(result_array!=null){
                    				for(int j=0;j<result_array.size();j++){
                    					JSONObject result_json=result_array.optJSONObject(j);
                    					out.print(result_json.optString("item_name")+"&nbsp;&nbsp;"+result_json.optString("first_result")+" "+result_json.optString("first_unit")+(result_json.optInt("second_result")!=0?result_json.optString("second_result")+" "+result_json.optString("second_unit"):"")+"&nbsp;&nbsp;|&nbsp;&nbsp;"+(j!=0&&j%3==0?"<br/>":""));
                    				}
                    			}
                    		}
      ...
      out.write("                        选中/取消所有\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td colspan=\"11\" style=\"text-align:right\"><input name=\"tjczft\" type=\"button\" onclick=\"batchdel()\"\r\n");
