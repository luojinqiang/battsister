 ...
 * Generated at: 2016-01-18 06:29:24 UTC
...
public final class gym_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/jianshenfang/../left.jsp", Long.valueOf(1451439994054L));
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",3005,") < 0) {
    ...
    if (action.equals("del")) {
        ...
        out.print(groupApi.delGym(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    ...
    //String gym_name = new String(ru.getString("gym_name", "").getBytes("ISO-8859-1"), "utf-8");
    String gym_name = ru.getString("gym_name");
    String gym_contact = ru.getString("gym_contact");
    //String gym_contact = new String(ru.getString("gym_contact", "").getBytes("ISO-8859-1"), "utf-8");
    String contract_end_time = ru.getString("contract_end_time", "");
    String contract_start_time = ru.getString("contract_start_time", "");
    int gymGroupId = ru.getInt("gymGroupId");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function gym_edit(id, title) {\r\n");
      out.write("            openurl('gym_edit.jsp?id=' + id + '', 'order', title, 900, 450, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("        function setwechat(gym_id,gym_group_id) {\r\n");
      out.write("            openurl('gym_wechat.jsp?gym_id=' + gym_id + '&gym_group_id='+gym_group_id+'', 'order', '微信设置', 900, 450, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      ...
      out.write("                                    tab: tab,\r\n");
      out.write("                                    options: {\r\n");
      out.write("                                        content: '<iframe src=\"' + urls + '\" frameborder=\"0\" width=\"100%\" scrolling=\"auto\" height=\"100%\"></iframe>'\r\n");
      out.write("                                    }\r\n");
      out.write("                                });\r\n");
      out.write("\r\n");
      out.write("            } else {\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.print(gym_name);
      out.write("\"/></li>\r\n");
      out.write("                <li>联系人：<input type=\"text\" name=\"gym_contact\" value=\"");
      out.print(gym_contact);
      out.write("\"/></li>\r\n");
      out.write("                <li>合同开始时间：\r\n");
      out.write("                    <input name=\"contract_start_time\"\r\n");
      out.write("                           value=\"");
      ...
      out.write("                <li>\r\n");
      out.write("                    合同结束时间：\r\n");
      out.write("                    <input name=\"contract_end_time\" value=\"");
      ...
      out.write("            <li>\r\n");
      out.write("                <a href=\"javascript:gym_edit(0,'新增健身房')\">新增健身房</a>\r\n");
      out.write("            </li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                    <th width=\"8%\">所属连锁</th>\r\n");
      out.write("                    <th width=\"10%\">电话</th>\r\n");
      out.write("                    <th width=\"5%\">联系人</th>\r\n");
      out.write("                    <th width=\"7%\">联系电话</th>\r\n");
      out.write("                    <th width=\"12%\">所在地区</th>\r\n");
      out.write("                    <th width=\"14%\">详细地址</th>\r\n");
      out.write("                    <th width=\"13%\">合同时间</th>\r\n");
      out.write("                    <th width=\"10%\">添加时间</th>\r\n");
      out.write("                    <th width=\"15\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_gym a left join g_province b on a.gym_province=b.provinceid "
                            + " left join g_city c on a.gym_city=c.cityid left join g_area d on a.gym_area=d.areaid left join hy_gym_group e on a.gym_group_id=e.id";
                    ...
                    if (!"".equals(gym_name)) {
                        sb.append(" and a.gym_name like ?");
                        sqllist.add("%" + gym_name + "%");
                    }
                    if (!("").equals(gym_contact)) {
                        sb.append(" and a.gym_contact like ?");
                        sqllist.add("%" + gym_contact + "%");
                    }
                    if (!("").equals(contract_start_time)
                            && !("").equals(contract_end_time)) {
								/*sb.append(" and a.contract_start_time>="+
										AjaxXml.getTimestamp(AjaxXml.Get_Date(contract_start_time,"YY04-MM-DD 00:00:00"))+" and "+
										AjaxXml.getTimestamp(AjaxXml.Get_Date(contract_start_time,"YY04-MM-DD 00:00:00"))+" <=a.contract_end_time"
										+" and "+" a.contract_start_time<="+
										AjaxXml.getTimestamp(AjaxXml.Get_Date(contract_end_time,"YY04-MM-DD 00:00:00"))+" and "+
										AjaxXml.getTimestamp(AjaxXml.Get_Date(contract_end_time,"YY04-MM-DD 00:00:00"))+" >=a.contract_end_time" );*/
                        sb.append("  and a.contract_start_time>="
                                + AjaxXml.getTimestamp(AjaxXml.Get_Date(
                                contract_start_time, "YY04-MM-DD 00:00:00")));
                        sb.append(" and a.contract_end_time <="
                                + AjaxXml.getTimestamp(AjaxXml.Get_Date(
                                contract_end_time, "YY04-MM-DD 00:00:00")));
                    }
                    int i = 1;
                    String file = "a.id,a.gym_group_id,a.gym_name,a.gym_phone, "
                            + "a.gym_mobile,a.gym_contact,b.province,c.city,d.area,a.gym_address,a.contract_start_time,a.contract_end_time,a.create_time,e.group_name";
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("gym_phone", "") != null) ? doc.get("gym_phone") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("gym_contact", "") != null) ? doc.get("gym_contact") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("gym_mobile", "") != null) ? doc.get("gym_mobile") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("gym_address", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(AjaxXml.timeStamp2Date(doc.getIn("contract_start_time"), "YY04-MM-DD"));
      out.write("\r\n");
      out.write("                        -\r\n");
      out.write("                        ");
      out.print(AjaxXml.timeStamp2Date(doc.getIn("contract_end_time"), "YY04-MM-DD"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <a href=\"javascript:window.parent.jianyi2('jianshenfang/gymDeviceTypeList.jsp?gymGroupId=");
      out.print(doc.getIn("gym_group_id"));
      out.write("&gymId=");
      out.print(doc.getIn("id"));
      out.write("','健身房设备类型')\">设备类型</a>\r\n");
      out.write("\r\n");
      out.write("                        <a href=\"javascript:window.parent.jianyi2('jianshenfang/gym_service_shop.jsp?gymGroupId=");
      out.print(doc.getIn("gym_group_id"));
      out.write("&gymId=");
      out.print(doc.getIn("id"));
      out.write("','服务消费')\">服务消费</a>\r\n");
      out.write("                        <a href=\"javascript:gym_edit(");
      out.print(doc.get("id"));
      out.write(",'编辑健身房')\">编辑</a>\r\n");
      out.write("                        <a href=\"javascript:del(");
      out.print(doc.get("id"));
      out.write(")\">删除</a> <a href=\"javascript:setwechat(");
      out.print(doc.get("id"));
      out.write(',');
      out.print(doc.getIn("gym_group_id"));
      out.write(")\">微信</a>\r\n");
