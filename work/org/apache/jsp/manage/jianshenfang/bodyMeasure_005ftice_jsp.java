 ...
 * Generated at: 2015-12-25 09:23:58 UTC
...
public final class bodyMeasure_005ftice_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",3051,") < 0) {
    ...
    int gymId = ru.getInt("gymId");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"bodyMeasure_tice.jsp\",\r\n");
      ...
      out.write("            var measure_type = 1;\r\n");
      out.write("            window.parent.jianyi2('jianshenfang/bodyMeasure_tice_edit.jsp?id=' + id + '&measure_type=' + measure_type + '', '体测编辑');\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("    <div class=\"form_info\"><strong>会员体能测试</strong></div>\r\n");
      ...
      out.write("            <li><a href=\"javascript:bodyMeasure(0,'新增会员体测')\">新增会员体测</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div> -->\r\n");
      ...
      out.write("                    <th width=\"5%\">教练名</th>\r\n");
      out.write("                    <th width=\"5%\">用户名</th>\r\n");
      out.write("                    <th width=\"12%\">体测时间</th>\r\n");
      out.write("                     <!--  <th width=\"5%\">当前体重</th>\r\n");
      out.write("                    <th width=\"4%\">体脂率</th>\r\n");
      out.write("                    <th width=\"5%\">脂肪重量</th>\r\n");
      out.write("                    <th width=\"6%\">骨骼肌重量</th>\r\n");
      out.write("                    <th width=\"4%\">胸围</th>\r\n");
      out.write("                    <th width=\"6%\">上臂围(左/右)</th>\r\n");
      out.write("                    <th width=\"4%\">腰围</th>\r\n");
      out.write("                    <th width=\"4%\">臀围</th>\r\n");
      out.write("                    <th width=\"6%\">大腿围(左/右)</th>\r\n");
      out.write("                    <th width=\"6%\">小腿围(左/右)</th>\r\n");
      out.write("                    <th width=\"6%\">身体总水分</th>\r\n");
      out.write("                    <th width=\"4%\">蛋白质</th>\r\n");
      out.write("                    <th width=\"4%\">无机盐</th>\r\n");
      out.write("                      <th width=\"6%\">身体质量指数</th>\r\n");
      out.write("                        <th width=\"6%\">细胞外水分比率</th> -->\r\n");
      out.write("                        <th width=\"68%\">体测指数</th>\r\n");
      out.write("                    <th width=\"\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_member_measure_tice a left join hy_member b on a.member_id=b.id left join hy_coach e on a.coach_id=e.id ";
                  ...
                  /*   if (order_status > 0) {
                    ...
                    int i = 1;
                    String file = "a.id,a.tice_time,a.mem_weight,a.tizhilv,a.zhifangzhongliang,"
                    		+"a.gugejizhongliang,a.xiongwei,a.shangbiwei,a.yaowei,tunwei,a.datuiwei,a.xiaotuiwei,a.shentishuifen,a.danbaizhi,a.wujiyan,a.shentizhiliangzhishu,a.xibaoshuifenbilv,a.summary," +
                            "  b.mem_name,mem_username,e.coach_name ";
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("mem_weight","")!=null&&!"".equals(doc.get("mem_weight",""))?"[当前体重:"+doc.get("mem_weight","")+" kg]":"");
      out.print(doc.get("tizhilv")!=null&&!"".equals(doc.get("tizhilv"))?" [体脂率:"+doc.get("tizhilv")+" %]":"");
      out.print(doc.get("zhifangzhongliang","")!=null&&!"".equals(doc.get("zhifangzhongliang",""))?" [脂肪重量:"+doc.get("zhifangzhongliang","")+" kg]":"");
      out.write("\r\n");
      out.write("                    ");
      out.print(doc.get("gugejizhongliang","")!=null&&!"".equals(doc.get("gugejizhongliang",""))?" 骨骼肌重量:"+doc.get("gugejizhongliang","")+" kg]":"");
      out.print(doc.get("xiongwei","")!=null&&!"".equals(doc.get("xiongwei",""))?" [胸围:"+doc.get("xiongwei","")+" cm]":"");
      out.print(doc.get("shangbiwei","")!=null&&!"".equals(doc.get("shangbiwei",""))?" [上臂围(左/右):"+doc.get("shangbiwei","")+" cm]":"");
      out.print(doc.get("yaowei","")!=null&&!"".equals(doc.get("yaowei",""))?" [腰围："+doc.get("yaowei","")+" cm]":"");
      out.write("\r\n");
      out.write("                    ");
      out.print(doc.get("tunwei","")!=null&&!"".equals(doc.get("tunwei",""))?" [臀围:"+doc.get("tunwei","")+" cm]":"");
      out.print(doc.get("datuiwei","")!=null&&!"".equals(doc.get("datuiwei",""))?" [大腿围(左/右):"+doc.get("datuiwei","")+" cm]":"");
      out.print(doc.get("xiaotuiwei","")!=null&&!"".equals(doc.get("xiaotuiwei",""))?" [小腿围(左/右):"+doc.get("xiaotuiwei","")+" cm]":"");
      out.write("\r\n");
      out.write("                   \t");
      out.print(doc.get("shentishuifen","")!=null&&!"".equals(doc.get("shentishuifen",""))?" [身体水分:"+doc.get("shentishuifen","")+"]":"");
      out.print(doc.get("danbaizhi","")!=null&&!"".equals(doc.get("danbaizhi",""))?" [蛋白质:"+doc.get("danbaizhi","")+" kg]":"");
      out.print(doc.get("wujiyan","")!=null&&!"".equals(doc.get("wujiyan",""))?" [无机盐:"+doc.get("wujiyan","")+" kg]":"");
      out.print(doc.get("shentizhiliangzhishu","")!=null&&!"".equals(doc.get("shentizhiliangzhishu",""))?" [身体质量指数:"+doc.get("shentizhiliangzhishu","")+"]":"");
      out.write("\r\n");
      out.write("                    ");
      out.print(doc.get("xibaoshuifenbilv","")!=null&&!"".equals(doc.get("xibaoshuifenbilv",""))?" [细胞外水分比率:"+doc.get("xibaoshuifenbilv","")+" %]":"");
      out.write("<br />\r\n");
      out.write("                    \t[总结:");
      out.print(doc.get("summary")+"]");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                       ");
      ...
      out.write("                        选中/取消所有\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td colspan=\"13\" style=\"text-align:right\"><input name=\"tjczft\" type=\"button\" onclick=\"batchdel()\"\r\n");
