 ...
 * Generated at: 2015-12-25 09:36:06 UTC
...
public final class jituan_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    if (action.equals("del")) {
        ...
        out.print(groupApi.delGroup(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
//String group_name=new String(ru.getString("group_name","").getBytes("ISO-8859-1"),"utf-8");
//String group_contact=new String(ru.getString("group_contact").getBytes("ISO-8859-1"),"utf-8");
    String group_name = ru.getString("group_name");
    String group_contact = ru.getString("group_contact");
    ...
    if (pn == 0) {
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function jituan_edit(id, title) {\r\n");
      out.write("            openurl('jituan_edit.jsp?id=' + id + '', 'order', title, 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("    <div class=\"form_info\"><strong>集团列表</strong></div>\r\n");
      ...
      out.write("                <li>集团名称：<input type=\"text\" name=\"group_name\" value=\"");
      out.print(group_name);
      out.write("\"/></li>\r\n");
      out.write("                <li>联系人：<input type=\"text\" name=\"group_contact\" value=\"");
      out.print(group_contact );
      out.write("\"/></li>\r\n");
      out.write("            </ul>\r\n");
      out.write("            <ul class=\"row3\" style=\"margin-top:3px;\">\r\n");
      out.write("                <li>合同开始时间：<input name=\"contract_start_time\" value=\"");
      out.print(contract_start_time );
      out.write("\"\r\n");
      out.write("                                  onclick=\"SelectDate(this,'yyyy-MM-dd',0,0)\"/></li>\r\n");
      out.write("                <li>合同结束时间： <input name=\"contract_end_time\" value=\"");
      ...
      out.write("            <li><a href=\"javascript:jituan_edit(0,'新增集团')\">新增集团</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                <tr>\r\n");
      out.write("                    <th width=\"10%\">集团名称</th>\r\n");
      out.write("                    <th width=\"7%\">集团电话</th>\r\n");
      out.write("                    <th width=\"6%\">联系人</th>\r\n");
      out.write("                    <th width=\"8%\">联系电话</th>\r\n");
      out.write("                    <th width=\"14%\">所在地区</th>\r\n");
      out.write("                    <th width=\"8%\">健身房数量</th>\r\n");
      out.write("                    <th width=\"15%\">合同时间</th>\r\n");
      out.write("                    <th width=\"12%\">添加时间</th>\r\n");
      out.write("                    <th>操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_gym_group a left join g_province b on a.group_province=b.provinceid " +
                            " left join g_city c on a.group_city=c.cityid left join g_area d on a.group_area=d.areaid";
                    StringBuffer sb = new StringBuffer(" a.isdel=0 ");
                    List sqllist = new ArrayList();
                    if (!("").equals(group_name)) {
                        sb.append(" and a.group_name like ?");
                        sqllist.add("%" + group_name + "%");
                    }
                    if (!("").equals(group_contact)) {
                        sb.append(" and a.group_contact like ?");
                        sqllist.add("%" + group_contact + "%");
                    }
                    if (!("").equals(contract_start_time) && !("").equals(contract_end_time)) {
	/*sb.append(" and a.contract_start_time>="+
			...
			AjaxXml.getTimestamp(AjaxXml.Get_Date(contract_end_time,"YY04-MM-DD 00:00:00"))+" >=a.contract_end_time" );*/
                        sb.append("  and a.contract_start_time>=" + AjaxXml.getTimestamp(AjaxXml.Get_Date(contract_start_time, "YY04-MM-DD 00:00:00")));
                        sb.append(" and a.contract_end_time <=" + AjaxXml.getTimestamp(AjaxXml.Get_Date(contract_end_time, "YY04-MM-DD 00:00:00")));
                    }
                    int i = 1;
                    String file = "a.id,a.group_name,a.group_phone,a.group_mobile, " +
                            "a.group_contact,b.province,c.city,d.area,a.group_address,a.gym_num,a.contract_start_time,a.contract_end_time,a.create_time";
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("group_phone", "") != null) ? doc.get("group_phone") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("group_contact", "") != null) ? doc.get("group_contact") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("group_mobile", "") != null) ? doc.get("group_mobile") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      ...
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td><a href=\"javascript:jituan_edit(");
      out.print(doc.get("id"));
      out.write(",'编辑集团')\">编辑</a> <a\r\n");
      out.write("                            href=\"../weixin/weixin.jsp\">微信设置</a> <a href=\"javascript:del(");
      out.print(doc.get("id") );
      out.write(")\">删除</a>\r\n");
      out.write("                    </td>\r\n");
      out.write("                </tr>\r\n");
