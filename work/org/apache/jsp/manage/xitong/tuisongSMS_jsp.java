 ...
 * Generated at: 2015-12-07 02:52:14 UTC
...
public final class tuisongSMS_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    if (current_flags.indexOf(",6008,") < 0) {
    ...
    if (action.equals("send")) {
        HYPush hyJpush = new HYPush();
        out.print(hyJpush.adminSendSms(request, user_name, userid, 1901, gym_group_id, gym_id));
        return;
    }
    String IMEI = "";
    String where = "where isdel=0 and LENGTH(mobile_imei) > 0";
    String tables = "hy_member";
    String files = "id,mem_name,mem_mobile,mem_sex,mobile_imei,mem_birth,CURDATE(),(YEAR(CURDATE())-YEAR(mem_birth))-(RIGHT(CURDATE(),5)<RIGHT(mem_birth,5)) AS age";
    List lists = utildb.Get_List(files, tables, where, "mysqlss");
    if (lists != null && !lists.isEmpty()) {
        for (Iterator its = lists.listIterator(); its.hasNext(); ) {
            Doc doc = (Doc) its.next();
            IMEI = IMEI + "," + doc.get("mobile_imei");
        }
    }
    String mem_name = ru.getString("mem_name");
    String mem_mobile = ru.getString("mem_mobile");
    String mem_sexs = ru.getString("mem_sexs");
      ...
      out.write("    <script type=\"text/javascript\" src=\"../js/artDialog4.1.6/artDialog.js?skin=blue\"></script>\r\n");
      out.write("    <script type=\"text/javascript\" src=\"../js/artDialog4.1.6/plugins/iframeTools.source.js\"></script>\r\n");
      out.write("    <script type='text/javascript' src='/public/js/member/global.js'></script>\r\n");
      ...
      out.write("    <script language=\"javascript\">$(document).ready(web_obj.column_edit_init);</script>\r\n");
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("\r\n");
      out.write("        function sendSMS(id) {\r\n");
      out.write("            var id = \"\";\r\n");
      out.write("            var SMSALL = getcheckbox(\"SMSALL\");\r\n");
      out.write("            if ($(\"#imeis\").val() != \"\") {\r\n");
      out.write("                id = $(\"#imeis\").val();\r\n");
      out.write("            } else {\r\n");
      out.write("                id = getcheckbox(\"id\");\r\n");
      out.write("                if (id == \"\" && SMSALL == \"\") {\r\n");
      ...
      out.write("                                },\r\n");
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"tuisongSMS.jsp\",\r\n");
      out.write("                                data: \"action=send&ids=\" + id + \"&SMSALL=\" + SMSALL + \"&title=\" + title + \"&content=\" + content + \"&mem_name=\" + mem_name + \"&mem_mobile=\" + mem_mobile + \"&mem_sexs=\" + mem_sexs + \"\",\r\n");
      ...
      out.write("            window.parent.art.dialog({id: \"shezhi\"}).close();\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function SMSALLs() {\r\n");
      out.write("            if (document.getElementById(\"SMSALL\").checked) {\r\n");
      out.write("                var imei = '");
      out.print(IMEI);
      out.write("';\r\n");
      out.write("                $(\"[name='id']:checkbox\").each(function () {\r\n");
      out.write("                    if (imei.indexOf(this.value) > -1) {\r\n");
      out.write("                        $(this).attr(\"checked\", true);\r\n");
      out.write("                    } else {\r\n");
      out.write("                        $(this).attr(\"checked\", false);\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("                $(\"#imeis\").val(imei);\r\n");
      out.write("            } else {\r\n");
      out.write("                var imei = '");
      out.print(IMEI);
      out.write("';\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("    <div class=\"form_info\"><strong>APP信息推送</strong></div>\r\n");
      out.write("    <div class=\"form_cont mb10\">\r\n");
      out.write("        <form id=\"form1\" name=\"form1\" method=\"get\" action=\"\">\r\n");
      out.write("            <input type=\"hidden\" name=\"imeis\" id=\"imeis\" value=\"\"/>\r\n");
      out.write("            <ul class=\"row3\">\r\n");
      out.write("\r\n");
      out.write("                <li>用户名：<input name=\"mem_name\" type=\"text\" id=\"mem_name\" value=\"");
      out.print(mem_name);
      ...
      out.write("                <li>性别：\r\n");
      out.write("                    <select style=\"width:100px;\" id=\"mem_sexs\" name=\"mem_sexs\">\r\n");
      out.write("                        <option value=\"\">--请选择--</option>\r\n");
      out.write("                        <option value=\"0\" ");

                            if (mem_sexs.equals("0")) {
                                out.print("selected");
                            }
      ...
      out.write("            <div class=\"\" style=\"float:left;width:45%;\">\r\n");
      out.write("                <div class=\"form_table\">\r\n");
      out.write("\r\n");
      out.write("                    <table cellpadding=\"0\" cellspacing=\"0\">\r\n");
      out.write("                        <tr>\r\n");
      out.write("                            <th width=\"2%\"></th>\r\n");
      out.write("                            <th width=\"7%\">用户名</th>\r\n");
      out.write("                            <th width=\"10%\">手机号码</th>\r\n");
      ...
      out.write("                        ");
                            ...
                            String wheres = " isdel=0 and LENGTH(mobile_imei) > 0";
                            if (!mem_name.equals("")) {
                                wheres = wheres + " and (mem_name like ? or mem_username like ?)";
                                sqllist.add("%" + URLEncoder.encode(mem_name, "utf-8") + "%");
                                sqllist.add("%" + mem_name + "%");
                            }
                            if (!mem_mobile.equals("")) {
                                wheres = wheres + " and mem_mobile like ?";
                                sqllist.add("%" + mem_mobile + "%");
                            }
                            if (!mem_sexs.equals("")) {
                                wheres = wheres + " and mem_sex=?";
                                sqllist.add(mem_sexs);
                            }
                            int pages = ru.getInt("page");
                            int pn = 20;
                            String table = "hy_member";
                            String file = "id,mem_name,mem_mobile,mem_username,mem_sex,mobile_imei,mem_birth,CURDATE(),(YEAR(CURDATE())-YEAR(mem_birth))-(RIGHT(CURDATE(),5)<RIGHT(mem_birth,5)) AS age";
                            String order = " order by id desc";
                            String idd = "id";
                            String content = "";
                            int mem_sex = 0;
                            int age = 0;
                            AjaxDate ajaxDate2 = new AjaxDate();
...
out.print(AjaxXml.getPage(pages, 10, pn, counts, "", "", "", request));
      ...
      out.write("                    <!--         <button type=\"button\" id=\"tjbutton\" onclick=\"usersave()\">关闭</button><span id=\"tisspan\"></span> -->\r\n");
      out.write("                    <!--       </div> -->\r\n");
      out.write("                </div>\r\n");
      out.write("            </div><!--r_iframe END-->\r\n");
      out.write("        </form>\r\n");
      out.write("        <div style=\"float:right;width:50%;padding-left:20px;padding-top:20px;\">\r\n");
      out.write("            <div>发送给所有人:<input type=\"checkbox\" id=\"SMSALL\" name=\"SMSALL\" value=\"1\"/></div>\r\n");
      out.write("            <div>标题:<input type=\"text\" name=\"title\" id=\"title\"/></div>\r\n");
      out.write("            <div>内容:<!-- textarea rows=\"8\" cols=\"50\" name=\"content\" id=\"content\"></textarea -->\r\n");
      out.write("                <script type=\"text/plain\" id=\"content\" name=\"content\" class=\"ckeditor\">\r\n");
      out.write("                    ");
      out.print(content );
      out.write("\r\n");
      out.write("                </script>\r\n");
      out.write("                <script type=\"text/javascript\">var editor = new baidu.editor.ui.Editor(edit_options);\r\n");
      out.write("                editor.render(\"content\");\r\n");
      out.write("                </script>\r\n");
      out.write("            </div>\r\n");
      out.write("            <div style=\"float:left;padding-top:20px;\"><input type=\"button\" onclick=\"sendSMS();\" value=\"发送\"/></div>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("    </div>\r\n");
      out.write("</div>\r\n");
