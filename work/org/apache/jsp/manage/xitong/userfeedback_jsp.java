 ...
 * Generated at: 2015-12-07 02:52:03 UTC
...
return;
    ...
    if (action.equals("del")) {
        MemberTwoApi ufb = new MemberTwoApi();
        out.print(ufb.delUserFeedback(request, userid, user_name));
        return;
    }
    if (action.equals("batchDel")) {
        MemberTwoApi ufb = new MemberTwoApi();
        out.print(ufb.batchDelUserFeedback(request, userid, user_name));
        return;
    }
//用户id
    ...
    int feedback_type = ru.getInt("feedback_type", -1);
      ...
      out.write("    <script type=\"text/javascript\" src='../js/qmango.js'></script>\r\n");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"userFeedback.jsp\",\r\n");
      ...
      out.write("            if ($(\"#mem_userid\").attr(\"value\") != \"\") {\r\n");
      out.write("                if (!reg.test($(\"#mem_userid\").attr(\"value\"))) {\r\n");
      out.write("                    alert(\"请输入合法账号\");\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("            reg = /^(\\d{4})-(\\d{2})-(\\d{2})$/\r\n");
      out.write("\r\n");
      out.write("            if ($(\"#start\").attr(\"value\") != \"\" || $(\"#end\").attr(\"value\") != \"\") {\r\n");
      out.write("                if (!reg.test($(\"#start\").attr(\"value\")) || !reg.test($(\"#end\").attr(\"value\"))) {\r\n");
      out.write("                    alert(\"请输入合法日期\");\r\n");
      out.write("                    return false;\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("    <div class=\"form_info\"><strong>用户反馈</strong></div>\r\n");
      out.write("    <div class=\"form_cont mb10\">\r\n");
      out.write("        <form id=\"form1\" name=\"form1\" method=\"get\" action=\"\">\r\n");
      out.write("            <ul class=\"row3\">\r\n");
      out.write("                <li>用户id：<input name=\"mem_userid\" type=\"text\" id=\"mem_userid\" value=\"");
      out.print(mem_userid);
      out.write("\"\r\n");
      out.write("                                style=\"width:100px;\"/>\r\n");
      out.write("                </li>\r\n");
      out.write("                <li>\r\n");
      out.write("                    用户名：<input name=\"mem_name\" type=\"text\" id=\"mem_name\" value=\"");
      out.print(mem_name);
      out.write("\" style=\"width:100px;\"/>\r\n");
      out.write("                </li>\r\n");
      out.write("\r\n");
      out.write("                <li>反馈类型：\r\n");
      out.write("                    <select name=\"feedback_type\">\r\n");
      out.write("                        <option value=\"-1\">--请选择反馈类型--</option>\r\n");
      out.write("                        <option value=\"0\" ");
      out.print( (feedback_type == 0 ? "selected" : "") );
      out.write(">用户APP端</option>\r\n");
      out.write("                        <option value=\"1\" ");
      out.print((feedback_type == 1 ? "selected" : "") );
      out.write(">教练端</option>\r\n");
      out.write("                    </select>\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
      out.write("            <ul class=\"row3\">\r\n");
      out.write("                <li>反馈时间：<input name=\"startTime\" type=\"text\"\r\n");
      out.write("                                id=\"start\" value=\"");
      out.print(feedBackTimeStart);
      out.write("\"\r\n");
      out.write("                                style=\"width:100px;\" onclick=\"SelectDate(this,'yyyy-MM-dd',0,0)\"/>\r\n");
      out.write("                    - <input name=\"endTime\" type=\"text\" id=\"end\"\r\n");
      out.write("                             value=\"");
      out.print(feedBackTimeEnd);
      out.write("\" style=\"width:100px;\"\r\n");
      out.write("                             onclick=\"SelectDate(this,'yyyy-MM-dd',0,0)\"/>\r\n");
      out.write("                </li>\r\n");
      out.write("\r\n");
      out.write("                <li>手机类型：<select name=\"mobile_type\">\r\n");
      out.write("                    <option value=\"0\">--请选择手机类型--</option>\r\n");
      out.write("                    <option value=\"1\" ");
      out.print( (mobile_type == 1 ? "selected" : "") );
      out.write(">安卓</option>\r\n");
      out.write("                    <option value=\"2\" ");
      out.print((mobile_type == 2 ? "selected" : "") );
      out.write(">IOS</option>\r\n");
      out.write("                </select>\r\n");
      out.write("                </li>\r\n");
      out.write("                <li class=\"btn_line\">\r\n");
      out.write("                    <button type=\"button\" class=\"btn_formA\" onclick=\"return validation()\">确定搜索</button>\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
      out.write("        </form>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                    <th width=\"7%\">手机类型</th>\r\n");
      out.write("                    <th width=\"7%\">反馈类型</th>\r\n");
      out.write("                    <th width=\"7%\">版本号</th>\r\n");
      out.write("                    <th width=\"20%\">反馈内容</th>\r\n");
      out.write("                    <th width=\"15%\">反馈时间</th>\r\n");
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("version") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("content") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
