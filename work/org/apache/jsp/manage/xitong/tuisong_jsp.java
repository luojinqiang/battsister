 ...
 * Generated at: 2015-12-07 02:52:10 UTC
...
public final class tuisong_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    if (action.equals("del")) {
        ...
        out.print(hyJpush.Delpush(request, user_name, userid, gym_group_id, gym_id));
        return;
    }
      ...
      out.write("        }\r\n");
      out.write("        function smsPush(id, title) {\r\n");
      out.write("            //openurl('tuisongSMS.jsp','shezhi',title,850,400,0,10,true);\r\n");
      out.write("            window.parent.jianyi2(\"xitong/tuisongSMS.jsp\", \"信息推送\");\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("            <li><a href=\"javascript:smsPush(0,'信息推送')\">信息推送</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                    <th width=\"7%\">标题</th>\r\n");
      out.write("                    <th width=\"10%\">接受的用户</th>\r\n");
      out.write("                    <th width=\"20%\">推送时间</th>\r\n");
      out.write("                    <th width=\"15%\">手机识别码</th>\r\n");
      out.write("                    <th width=\"7%\">状态</th>\r\n");
      out.write("                    <th width=\"39%\">推送内容</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("\r\n");
      out.write("                ");
                    ...
                    int pn = 20;
                    String table = "hy_app_push";
                    String file = "*";
                    String order = " order by id desc";
                    String idd = "id";
                    String content = "";
                    int counts = utildb.Get_count(idd, table, wheres, "");
                    List list = utildb.Get_mssqlList(pages, pn, counts, table, wheres, file, order, idd, "");
                    if (list != null) {
      ...
      out.write("                    <td>");
                        ...
                        if (doc.get("mem_userid") != null) {
                            if (doc.get("mem_userid").length() > 23) {
                                out.print(doc.get("mem_userid").substring(0, 22) + "...");
                            } else {
      ...
      out.write("</td>\r\n");
      out.write("                    <td>");
      out.print(AjaxXml.Get_Date(doc.get("pushtime"), "YY04-MM-DD HH:MI:SS") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");

                        if (doc.get("mobile_imei") != null) {
                            if (doc.get("mobile_imei").length() > 23) {
                                out.print(doc.get("mobile_imei").substring(0, 22) + "...");
                            } else {
                                out.print(doc.get("mobile_imei"));
                            }
                        }
