 ...
 * Generated at: 2015-12-23 03:03:02 UTC
...
public final class thirdPartyApply_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/xitong/../left.jsp", Long.valueOf(1450407753560L));
...
return;
    ...
    if ("del".equals(action)) {
        ...
        out.print(al.thirdPartyApplyDel(request, userid, user_name, gym_group_id, gym_id));
        return;
    }
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"thirdPartyApply.jsp\",\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("    <div class=\"form_info\"><strong>加盟申请列表</strong></div>\r\n");
      ...
      out.write("                    <th width=\"18%\">公司名称</th>\r\n");
      out.write("                    <th width=\"18%\">公司地址</th>\r\n");
      out.write("                    <th width=\"10%\">联系人</th>\r\n");
      out.write("                    <th width=\"12%\">联系电话</th>\r\n");
      out.write("                    <th width=\"18%\">说明</th>\r\n");
      out.write("                    <th width=\"13%\">申请时间</th>\r\n");
      out.write("                    <th width=\"\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");


                    String table = "hy_sys_feedback";
                    String wheres = "isdel=0 and type=1";
                    String file = "id,content,create_time";
                    String order = " order by create_time desc";
                    String idd = "id";
                    String src = "";
                    int counts = utildb.Get_count(idd, table, wheres, "mysqlss", new Object[]{});
                    List list = utildb.Get_List(pages, pn, counts, table, wheres, file, order, "mysqlss", new ArrayList());
                    if (list != null) {
                        for (Iterator its = list.listIterator(); its.hasNext(); ) {
                            Doc doc = (Doc) its.next();
                            String jsonText = doc.get("content");
      ...
      out.write("\r\n");
      out.write("                    <td>");
      out.print(json.optString("companyName", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(json.optString("companyAddress", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(json.optString("contactMan", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(json.optString("contactPhone", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(json.optString("otherExplain", ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      ...
      out.write("\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td colspan=\"2\" style=\"text-align:center\"><!-- <input type=\"checkbox\" name=\"chkall\" id=\"chkall\" value=\"checkbox\" onclick=\"CheckAll(this.form);\" />\r\n");
      out.write("         选中/取消所有   -->\r\n");
      out.write("                    </td>\r\n");
