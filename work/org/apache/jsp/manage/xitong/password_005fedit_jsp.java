 ...
 * Generated at: 2015-12-25 09:30:14 UTC
...
public final class password_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/xitong/../left.jsp", Long.valueOf(1451029963556L));
...
/*if (id==0){
    ...
    String logstarttime = AjaxXml.Get_Date("now", "YY04-MM-DD HH:MI:SS");
      ...
      out.write("                window.parent.art.dialog.alert('请输入用户密码');\r\n");
      out.write("                return;\r\n");
      out.write("            }\r\n");
      ...
      out.write("                type: \"post\",\r\n");
      out.write("                url: \"password_edit.jsp\",\r\n");
      out.write("                data: \"id=\" + id + \"&action=\" + action + \"&user_name=\" + user_name + \"&user_pwd=\" + password + \"&user_pwd2=\" + password1,\r\n");
      out.write("\r\n");
      ...
      out.write("                                window.parent.location.href = \"/manage/login.jsp\";\r\n");
      out.write("                            }\r\n");
      out.write("                        });\r\n");
      out.write("                    } else {\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("            <input name=\"userid\" id=\"id\" type=\"hidden\" value=\"");
      out.print(userid);
      out.write("\"/>\r\n");
