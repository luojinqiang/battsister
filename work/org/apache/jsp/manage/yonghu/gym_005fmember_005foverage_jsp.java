 ...
 * Generated at: 2015-12-07 02:50:14 UTC
...
public final class gym_005fmember_005foverage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/yonghu/../left.jsp", Long.valueOf(1448868343375L));
  }
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",1009,") < 0) {
    ...
    if (action.equals("del")) {
        ...
        out.print(fp.delplan(request, userid, user_name, gym_group_id,
                gym_id).toString());
        return;
    }
    if (action.equals("batchdel")) {
        FitnessPlan fp = new FitnessPlan();
        out.print(fp.batchDelplan(request, userid, user_name,
    ...
    int mem_user_card = ru.getInt("mem_user_card", -1);
    int in_or_de = ru.getInt("in_or_de");
    int overage_shop_type = ru.getInt("overage_shop_type", -1);
      ...
      out.write("                            type: \"post\",\r\n");
      out.write("                            url: \"order_member_plan.jsp\",\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function addplan(id, title) {\r\n");
      out.write("            openurl('order_member_plan_edit.jsp?id=' + id + '', 'user', title, 700,\r\n");
      out.write("                    380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("        <strong>用户余额资金流向表</strong>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("\r\n");
      out.write("                <li>用户会员卡类型：\r\n");
      out.write("                    <select name=\"mem_user_card\" id=\"mem_user_card\">\r\n");
      out.write("                        <option value=\"-1\">--用户会员卡类型--</option>\r\n");
      out.write("                        <option value=\"0\" ");
      out.print((mem_user_card == 0 ? "selected" : ""));
      out.write(">非会员</option>\r\n");
      out.write("                        <option value=\"1\" ");
      out.print((mem_user_card == 1 ? "selected" : ""));
      out.write(">会员卡</option>\r\n");
      out.write("                        <option value=\"2\" ");
      out.print((mem_user_card == 2 ? "selected" : ""));
      out.write(">健身房季度卡</option>\r\n");
      out.write("                        <option value=\"3\" ");
      out.print((mem_user_card == 3 ? "selected" : ""));
      out.write(">VIP会员卡</option>\r\n");
      out.write("                        <option value=\"4\" ");
      out.print((mem_user_card == 4 ? "selected" : ""));
      out.write(">智能VIP会员卡</option>\r\n");
      out.write("                        <option value=\"5\" ");
      out.print((mem_user_card == 5 ? "selected" : ""));
      out.write(">超级VIP会员卡</option>\r\n");
      out.write("                    </select>\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
      out.write("\r\n");
      ...
      out.write("                <li>余额变动：\r\n");
      out.write("                    <select name=\"in_or_de\" id=\"in_or_de\">\r\n");
      out.write("                        <option value=\"0\">--请选择余额变动--</option>\r\n");
      out.write("                        <option value=\"1\" ");
      out.print((in_or_de == 1 ? "selected" : ""));
      out.write(">增加</option>\r\n");
      out.write("                        <option value=\"-1\" ");
      out.print((in_or_de == -1 ? "selected" : ""));
      out.write(">减少</option>\r\n");
      ...
      out.write("            </ul>\r\n");
      out.write("\r\n");
      out.write("            <ul class=\"row1\" style=\"margin-top: 3px;\">\r\n");
      out.write("                <li>消费类型：\r\n");
      out.write("                    <select name=\"overage_shop_type\" id=\"overage_shop_type\">\r\n");
      out.write("                        <option value=\"-1\">--请选择消费类型--</option>\r\n");
      out.write("                        <option value=\"0\"");
      out.print((overage_shop_type == 0 ? "selected" : ""));
      out.write(">购买消费商品</option>\r\n");
      out.write("                        <option value=\"1\"");
      out.print((overage_shop_type == 1 ? "selected" : ""));
      out.write(">购买私教</option>\r\n");
      out.write("                        <option value=\"2\"");
      out.print((overage_shop_type == 2 ? "selected" : ""));
      out.write(">购买团队私教</option>\r\n");
      out.write("                        <option value=\"3\"");
      out.print((overage_shop_type == 3 ? "selected" : ""));
      out.write(">购买次卡</option>\r\n");
      out.write("                        <option value=\"4\"");
      out.print((overage_shop_type == 4 ? "selected" : ""));
      out.write(">购买体测</option>\r\n");
      out.write("                        <option value=\"5\"");
      out.print((overage_shop_type == 5 ? "selected" : ""));
      out.write(">充值</option>\r\n");
      out.write("                    </select>\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
      ...
      out.write("                    <th width=\"8%\">会员呢称</th>\r\n");
      out.write("                    <th width=\"8%\">用户会员卡类型</th>\r\n");
      out.write("                    <th width=\"8%\">订单编号</th>\r\n");
      out.write("                    <th width=\"8%\">余额变动</th>\r\n");
      out.write("                    <th width=\"8%\">金额数</th>\r\n");
      out.write("                    <th width=\"10%\">消费类型</th>\r\n");
      out.write("                    <th width=\"12\">创建时间\r\n");
      out.write("                    </th>\r\n");
      out.write("                    ");
      out.write("\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");
                    ...
                    String table = "hy_gym_member_overage a left join hy_member b on a.mem_userid=b.id left join hy_gym_group c on a.gym_group_id=c.id "
                            + " left join hy_gym d on a.gym_id=d.id left join hy_gym_order e on a.order_id=e.id  ";
                    ...
                    if (mem_user_card == 0) {
                        sb.append(" and a.mem_user_card=0");
                    } else if (mem_user_card == 1) {
                        sb.append(" and a.mem_user_card=1");
                    } else if (mem_user_card == 2) {
                        sb.append(" and a.mem_user_card=2");
                    } else if (mem_user_card == 3) {
                        sb.append(" and a.mem_user_card=3");
                    } else if (mem_user_card == 4) {
                        sb.append(" and a.mem_user_card=4");
                    } else if (mem_user_card == 5) {
                        sb.append(" and a.mem_user_card=5");
                    }

                    if (in_or_de == 1) {
                        sb.append(" and a.in_or_de=1");
                    } else if (in_or_de == -1) {
                        sb.append(" and a.in_or_de=-1");
                    }

                    if (overage_shop_type == 0) {
                        sb.append(" and a.overage_shop_type=0");
                    } else if (overage_shop_type == 1) {
                        sb.append(" and a.overage_shop_type=1");
                    } else if (overage_shop_type == 2) {
                        sb.append(" and a.overage_shop_type=2");
                    } else if (overage_shop_type == 3) {
                        sb.append(" and a.overage_shop_type=3");
                    } else if (overage_shop_type == 4) {
                        sb.append(" and a.overage_shop_type=4");
                    } else if (overage_shop_type == 5) {
                        sb.append(" and a.overage_shop_type=5");
                    }

                    int i = 1;
                    String file = "a.id,a.mem_user_card,a.in_or_de,a.overage_price, a.overage_shop_type,a.create_time,"
                            + "  b.mem_name,b.mem_username,c.group_name,d.gym_name,e.order_no ";
                    String order = " order by a.id desc";
                    String idd = "a.id";
                    i = pages * pn - pn + i;
                    int counts = utildb.Get_count(idd, table, sb.toString(), "mysqlss",
                            sqllist);
                    List list = utildb.Get_List(pages, pn, counts, table,
                            sb.toString(), file, order, "mysqlss", sqllist);
                    if (list != null) {
      ...
      out.write("                    <td><input name=\"id\" type=\"hidden\" id=\"id\" value=\"");
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("mem_username", "") != null ? doc.get("mem_username") : ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(BasicType.getMemUserCard(doc.getIn("mem_user_card")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("overage_price") / 100);
      out.write("元\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(BasicType.getOverageShopType(doc.getIn("overage_shop_type")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(AjaxXml.timeStamp2Date(doc.getIn("create_time"),
                            "YY04-MM-DD HH:MI:SS"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    ");
      ...
      out.write("                    ");
      out.write("\r\n");
      out.write("                    <td colspan=\"11\" style=\"text-align: right\">\r\n");
      out.write("                        ");
      out.write("\r\n");
      out.write("                        ");
      ...
      out.write("<!--End Sidebar-->\r\n");
      out.write("</body>\r\n");
      out.write("<script>$(document).ready(getGyms('select[name=gymGroupId]', '");
      out.print(gymId);
      out.write("'));</script>\r\n");
      out.write("\r\n");
      out.write("</html>");
