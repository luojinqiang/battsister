 ...
 * Generated at: 2015-12-18 05:58:45 UTC
...
public final class level_005fexperience_005foperating_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/yonghu/../left.jsp", Long.valueOf(1450407753560L));
  }
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",1005,") < 0) {
    ...
    if (action.equals("del")) {
        out.print(ml.setExperienceOperatingDel(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    if (action.equals("status")) {
        out.print(ml.setExperienceOperatingStatus(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    if (action.equals("display")) {
        out.print(ml.setExperienceOperatingDisplay(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    int operating_type = ru.getInt("operating_type");
    String operating_name = ru.getString("operating_name");
//String operating_name=new String(ru.getString("operating_name").getBytes("ISO-8859-1"),"UTF-8");
    int group_id = ru.getInt("group_id");
    int get_is_status = ru.getInt("get_is_status", -1);
    int is_display = ru.getInt("is_display", -1);
      ...
      out.write("\r\n");
      out.write("            openurl('level_experience_operating_edit.jsp?operating_type=");
      out.print(operating_type);
      out.write("&id=' + id + '', 'level', str + '操作', 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"level_experience_operating.jsp\",\r\n");
      ...
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("        function status(id, is_status) {\r\n");
      out.write("            var tips = \"隐藏\";\r\n");
      out.write("            if (is_status == 0) {\r\n");
      out.write("                tips = \"使用\";\r\n");
      out.write("            }\r\n");
      out.write("            art.dialog({\r\n");
      out.write("                id: 'delID',\r\n");
      out.write("                content: '是否确定' + tips + '选中项？',\r\n");
      out.write("                lock: true,\r\n");
      out.write("                button: [\r\n");
      out.write("                    {\r\n");
      out.write("                        name: '确定',\r\n");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"level_experience_operating.jsp\",\r\n");
      out.write("                                data: \"action=status&id=\" + id + \"&is_status=\" + is_status + \"\",\r\n");
      out.write("                                success: function (msg) {\r\n");
      out.write("                                    art.dialog({id: 'tisID'}).close();\r\n");
      out.write("                                    if (msg.type == true) {\r\n");
      out.write("                                        art.dialog({\r\n");
      ...
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("        function display(id, is_display) {\r\n");
      out.write("            var tips = \"不显示\";\r\n");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"level_experience_operating.jsp\",\r\n");
      out.write("                                data: \"action=display&id=\" + id + \"&is_display=\" + is_display + \"\",\r\n");
      out.write("                                success: function (msg) {\r\n");
      out.write("                                    art.dialog({id: 'tisID'}).close();\r\n");
      out.write("                                    if (msg.type == true) {\r\n");
      out.write("                                        art.dialog({\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.print(ml.getExperienceTyp(operating_type) );
      out.write("操作管理</strong></div>\r\n");
      out.write("    <div class=\"form_cont mb10\">\r\n");
      out.write("        <form id=\"form1\" name=\"form1\" method=\"get\" action=\"\">\r\n");
      out.write("            <input type=\"hidden\" id=\"operating_type\" name=\"operating_type\" value=\"");
      out.print(operating_type );
      out.write("\"/>\r\n");
      out.write("            <ul class=\"row3\">\r\n");
      out.write("                <li>名称：<input name=\"operating_name\" type=\"text\" id=\"operating_name\" value=\"");
      out.print(operating_name);
      out.write("\"\r\n");
      out.write("                              style=\"width:100px;\"/></li>\r\n");
      out.write("                <li>组别：<select name=\"group_id\" id=\"group_id\">\r\n");
      out.write("                    <option value=\"0\">选择组别</option>\r\n");
      out.write("                    ");
      out.print(ml.getExperienceGroupSelect(operating_type, 0, group_id));
      out.write("\r\n");
      out.write("                </select></li>\r\n");
      out.write("                <li>使用状态：<select name=\"get_is_status\" id=\"get_is_status\">\r\n");
      out.write("                    <option value=\"-1\" ");
      out.print((get_is_status == -1) ? "selected=\"selected\"" : "" );
      out.write(">选择状态</option>\r\n");
      out.write("                    <option value=\"0\" ");
      out.print((get_is_status == 0) ? "selected=\"selected\"" : "" );
      out.write(">正常</option>\r\n");
      out.write("                    <option value=\"1\" ");
      out.print((get_is_status == 1) ? "selected=\"selected\"" : "" );
      out.write(">隐藏</option>\r\n");
      out.write("                </select></li>\r\n");
      out.write("                <li>显示状态：<select name=\"is_display\" id=\"is_display\">\r\n");
      out.write("                    <option value=\"-1\" ");
      out.print((is_display == -1) ? "selected=\"selected\"" : "" );
      out.write(">选择状态</option>\r\n");
      out.write("                    <option value=\"0\" ");
      out.print((is_display == 0) ? "selected=\"selected\"" : "" );
      out.write(">显示</option>\r\n");
      out.write("                    <option value=\"1\" ");
      out.print((is_display == 1) ? "selected=\"selected\"" : "" );
      ...
      out.write("            <li><a href=\"javascript:edit(0)\">新增操作</a></li>\r\n");
      out.write("\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                <tr>\r\n");
      out.write("                    <td width=\"10%\">名称</td>\r\n");
      out.write("                    <td width=\"8%\">编码</td>\r\n");
      out.write("                    <td width=\"10%\">组别</td>\r\n");
      out.write("                    <td width=\"8%\">加减类型</td>\r\n");
      out.write("                    <td width=\"8%\">使用状态</td>\r\n");
      out.write("                    <td width=\"8%\">显示状态</td>\r\n");
      out.write("                    <td width=\"13%\">限制类型</td>\r\n");
      out.write("                    <td width=\"7%\">限制次数</td>\r\n");
      out.write("                    <td width=\"10%\">限制总值</td>\r\n");
      out.write("                    <td width=\"10%\">分数</td>\r\n");
      ...
      out.write("                ");
                    ...
                    String table = "hy_level_experience_operating";
                    String wheres = "isdel=0 and operating_type=?";
                    List sqllist = new ArrayList();
                    sqllist.add(operating_type);
                    if (!operating_name.equals("")) {
                        wheres = wheres + " and operating_name like ?";
                        sqllist.add("%" + operating_name + "%");
                    }
                    if (group_id > 0) {
                        wheres = wheres + " and group_id=?";
                        sqllist.add(group_id);
                    }
                    if (get_is_status > -1) {
                        wheres = wheres + " and is_status=?";
                        sqllist.add(get_is_status);
                    }
                    if (is_display > -1) {
                        wheres = wheres + " and is_display=?";
                        sqllist.add(is_display);
                    }
                    ...
                    String file = "id,operating_name,operating_coding,group_id,operating_type,in_or_de,is_status,stint_type,stint_times,stint_value,operating_value,is_display";
                    String order = " order by group_id asc,id asc";
                    String idd = "id";
                    i = pages * pn - pn + i;
                    String src = "";
...
//System.out.println(wheres);
                    ...
                    if (list != null) {
                        Doc groupDoc = ml.getExperienceGroupDoc(operating_type, 0);
      ...
      out.print(doc.get("operating_name"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("operating_coding"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(groupDoc.get("group_name_" + doc.get("group_id"), ""));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.getIn("in_or_de") == 1) ? "增加" : "减少");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.getIn("is_status") == 0) ? "<a href=\"javascript:status(" + doc.get("id") + ",1)\">正常</a>" : "<a href=\"javascript:status(" + doc.get("id") + ",0)\">隐藏</a>");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.getIn("is_display") == 0) ? "<a href=\"javascript:display(" + doc.get("id") + ",1)\">显示</a>" : "<a href=\"javascript:display(" + doc.get("id") + ",0)\">不显示</a>");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(ml.getExperienceOperatingStintType(doc.getIn("stint_type")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("stint_times"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("stint_value"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("operating_value"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
