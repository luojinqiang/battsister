 ...
 * Generated at: 2015-12-18 07:06:17 UTC
...
public final class common_005flanguage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    if (action.equals("del")) {
        out.print(commonLanguageAPI.delCommonLanguage(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    if (action.equals("batchdel")) {
        out.print(commonLanguageAPI.batchDelCommonLanguage(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    ...
    int coach_id=ru.getInt("coach_id");//教练id
      ...
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("        function addCommon(id,title) {\r\n");
      out.write("            openurl('common_language_edit.jsp?id=' + id + '', 'user', title, 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("        <strong>教练常用语列表</strong>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write('"');
      out.print(doc.getIn("id")==coach_id?"selected=\"selected\"":"");
      out.write('>');
      ...
      out.write("            <li><a href=\"javascript:addCommon(0,'新增常用语')\">新增常用语</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                    \t\t<td width=\"20%\">父节点</td>\r\n");
      out.write("                      \t\t<td width=\"12%\">所有者</td>\r\n");
      out.write("                    \t\t\t<td width=\"25%\">内容</td>\r\n");
      out.write("                    \t\t\t\t<td width=\"16%\">创建时间</td>\r\n");
      out.write("                    \t\t\t\t\t<td width=\"\">操作</td>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table2 = "hy_coach_common_language a left join hy_coach b on a.coach_id=b.id";
                    StringBuffer wheres = new StringBuffer(" a.isdel=0 ");
                    String order = " order by a.id desc";
                    String idd = "a.id";
                    List list2 = new ArrayList();
                    if(coach_id>0){
                    	wheres.append(" and a.coach_id=? ");
                    	list2.add(coach_id);
                    }else if(coach_id==-1){
                    	wheres.append(" and a.coach_id=? ");
                    	list2.add(0);
                    ...
                    String file2 = "a.id,a.content,b.coach_name,a.coach_id,a.class_id,a.create_time";
      ...
      out.write("\"/></td>\r\n");
      out.write("                     <td>");
      out.print(commonLanguageAPI.getParentName(doc.getIn("class_id")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("coach_id")>0?doc.get("coach_name"):"系统默认");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                    \t");
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <a href=\"javascript:addCommon('");
      out.print(doc.get("id"));
      out.write("','编辑常用语')\">编辑</a>\r\n");
