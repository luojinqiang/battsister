 ...
 * Generated at: 2016-01-18 05:43:02 UTC
...
public final class default_005faction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/order/../left.jsp", Long.valueOf(1451439994054L));
...
return;
    ...
    int plan_id = ru.getInt("plan_id");
    if (action.equals("del")) {
        out.print(fp.actiondel(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    if (action.equals("batchdel")) {
        out.print(fp.actionDelBatch(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    ...
    int action_type = ru.getInt("action_type");
    String action_name = ru.getString("action_name");
    int coach_id=ru.getInt("coach_id");//教练id
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"member_plan_action.jsp\",\r\n");
      ...
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("        function addaction(id, title) {\r\n");
      out.write("            openurl('default_action_edit.jsp?id=' + id + '', 'user', title, 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("        <strong>健身房默认动作列表</strong>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                <li>\r\n");
      out.write("                    动作类型：\r\n");
      out.write("                    <select name=\"action_type\">\r\n");
      out.write("                        <option value=\"0\">--动作类型--</option>\r\n");
      out.write("                        ");

                            JSONArray Types = utildb.getJsonArray("select type_name,id from hy_member_action_type where isdel=0 and type=0 ", "", new ArrayList());
                            if (!Types.isEmpty()) {
                                for (Object o : Types) {
      ...
      out.write("                <li>\r\n");
      out.write("                \t教练名：\r\n");
      out.write("                \t<select name=\"coach_id\">\r\n");
      out.write("                \t<option value=\"0\">--全部--</option>\r\n");
      out.write("                \t<option value=\"-1\" ");
      out.print(coach_id==-1?"selected=\"selected\"":"");
      out.write(">--系统默认--</option>\r\n");
      out.write("                \t\t");
      ...
      out.write("                <li>\r\n");
      out.write("                    动作名称：\r\n");
      out.write("                    <input type=\"text\" name=\"action_name\" value=\"");
      ...
      out.write("            <li><a href=\"javascript:addaction(0,'新增默认动作')\">新增默认动作</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                    <td width=\"8%\">动作类型</td>\r\n");
      out.write("                    <td width=\"8%\">动作名称</td>\r\n");
      out.write("                    <!--   <td width=\"20%\">动作介绍</td> -->\r\n");
      out.write("                    <td width=\"18%\">视频地址</td>\r\n");
      out.write("                   <!--  <td width=\"4%\">训练时间</td> -->\r\n");
      out.write("                    <td width=\"6%\">卡路里</td>\r\n");
      out.write("                    <td width=\"8%\">训练部位</td>\r\n");
      out.write("                    <td width=\"8%\">训练机械</td>\r\n");
      out.write("                    <td width=\"8%\">动作单位</td>\r\n");
      out.write("                    <td width=\"6%\">操作说明</td>\r\n");
      out.write("\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table2 = "hy_member_plan_action";
                    StringBuffer wheres = new StringBuffer(" isdel=0 ");
                    String order = " order by id desc";
                    String idd = "id";
                    List list2 = new ArrayList();
                    if (action_type > 0) {
                        wheres.append(" and action_type=? ");
                        list2.add(action_type);
                    }
                    if (action_name != null && !"".equals(action_name)) {
                        wheres.append(" and title like ?");
                        list2.add("%" + action_name + "%");
                    }
                    if(coach_id>0){
                    	wheres.append(" and coach_id=? ");
                    	list2.add(coach_id);
                    }
                    JSONArray unitTypes = Units.getUnitType();
                    JSONArray actionTypes = FitnessPlanTiem.getActionType();
                    String file2 = "id,title,content,video_path,kal,train_position,action_device,unit_name,action_type";
                    int counts = utildb.Get_count(idd, table2, wheres.toString(), "mysqlss", list2);
                    List list = utildb.Get_List(pages, pn, counts, table2, wheres.toString(), file2, order, "mysqlss", list2);
                    if (list != null) {
                        for (Iterator its = list.listIterator(); its.hasNext(); ) {
                            Doc doc2 = (Doc) its.next();
                            String actionType = "";
                            if (!actionTypes.isEmpty()) {
                                for (Object u : actionTypes) {
                                    JSONObject actionObj = JSONObject.fromObject(u);
                                    if (actionObj.optInt("id") == doc2.getIn("action_type")) {
                                        actionType = actionObj.optString("type_name");
                                        break;
                                    }
                                }
                            }
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc2.get("title") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    ");
      out.write("\r\n");
      out.write("                    <td><a href=\"");
      out.print(doc2.getString("video_path") );
      ...
      out.write("\r\n");
      out.write("                    <td>");
      out.print(doc2.getIn("kal") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc2.get("train_position", "") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc2.get("action_device", "") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc2.get("unit_name"));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>\r\n");
      out.write("                        <a href=\"javascript:addaction('");
      out.print(doc2.get("id"));
      out.write("','编辑健身计划')\">编辑</a>\r\n");
      ...
      out.write("                        选中/取消所有\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td colspan=\"10\" style=\"text-align:right\"><input name=\"tjczft\" type=\"button\" onclick=\"batchdel()\"\r\n");
