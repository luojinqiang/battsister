 ...
 * Generated at: 2015-12-25 09:35:38 UTC
...
public final class hy_005forder_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    int order_type=ru.getInt("order_type");
      ...
      out.write("    </script>\r\n");
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("        function order_details(id, title) {\r\n");
      out.write("            openurl('hy_order_detail.jsp?order_id=' + id, 'order', title, 700, 380, 0,\r\n");
      out.write("                    10, true);\r\n");
      out.write("        }\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("        <strong>健身房微信订单列表</strong>\r\n");
      out.write("    </div>\r\n");
      ...
      out.write("                    ");
                    ...
                    List<Doc> statusList=BasicType.getBookStatusList();
                    if(statusList!=null){
                    	for(Doc doc:statusList){
      ...
      out.write('"');
      out.write(' ');
      out.print((doc.getIn("id")+1)==order_status?"selected=\"selected\"":"");
      out.write('>');
      out.print(doc.get("status"));
      out.write("</option>\r\n");
      out.write("                    \t\t");
      ...
      out.write("            <ul class=\"row3\" style=\"margin-top: 3px;\">\r\n");
      out.write("             <li>订单类型：\r\n");
      out.write("             \t<select name=\"order_type\">\r\n");
      out.write("             \t\t<option value=\"0\">--全部--</option>\r\n");
      out.write("             \t\t<option value=\"1\" ");
      out.print(order_type==1?"selected=\"selected\"":"");
      out.write(">私教</option>\r\n");
      out.write("             \t\t<option value=\"2\" ");
      out.print(order_type==2?"selected=\"selected\"":"");
      out.write(">团队课</option>\r\n");
      out.write("             \t\t<option value=\"3\" ");
      out.print(order_type==3?"selected=\"selected\"":"");
      out.write(">充值</option>\r\n");
      out.write("             \t</select>\r\n");
      out.write("             </li>\r\n");
      ...
      out.write("                    <th width=\"11%\">订单号</th>\r\n");
      out.write("                    <th width=\"6%\">订单类型</th>\r\n");
      out.write("                    <th width=\"9%\">市场价</th>\r\n");
      out.write("                    <th width=\"9%\">付款价</th>\r\n");
      out.write("                    <th width=\"8%\">支付类型</th>\r\n");
      out.write("                    <th width=\"11%\">订单状态</th>\r\n");
      out.write("                    <th width=\"\">添加时间</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "pro_order a left join hy_gym_group b on a.gym_group_id=b.id left join hy_gym c on a.gym_id=c.id" +
                            " left join wx_card_user m on a.mem_userid=m.id ";
                    ...
                    if(order_status>0){
                    	sb.append(" and a.trade_status=? ");
                    	sqllist.add(order_status);
                    }
                    if(order_type>0){
                    	sb.append(" and a.order_type=? ");
                    	sqllist.add(order_type);
                    }
                    String file = "a.total_market_price,a.total_sale_price,a.total_pay_price,a.trade_status,a.pay_time,a.pay_no,a.order_no,a.create_time,a.order_type,b.group_name,c.gym_name,m.username";
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(df.format(AjaxXml.getDouble(doc.get("total_market_price", "0")) / 100));
      out.write("元</td>\r\n");
      out.write("                    <td>");
      out.print(df.format(AjaxXml.getDouble(doc.get("total_pay_price", "0")) / 100) );
      out.write("元</td>\r\n");
      out.write("                    <td>微信支付</td>\r\n");
      out.write("                    <td>");
      out.print(BasicType.getOrderStatus(doc.getIn("trade_status"))+(doc.getIn("trade_status")==1?" 付款时间:"+AjaxXml.timeStamp2Date(doc.getIn("pay_time"),"YY04-MM-DD HH:MI:SS"):""));
      out.write("</td>\r\n");
      out.write("                    <td>");
      ...
      out.write("\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td colspan=\"12\" style=\"text-align: right\">\r\n");
      out.write("                        ");
