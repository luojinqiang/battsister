 ...
 * Generated at: 2015-12-07 03:09:20 UTC
...
public final class hy_005fgym_005forder_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/order/../left.jsp", Long.valueOf(1448868343375L));
...
return;
    ...
    request.setCharacterEncoding("utf-8");
    if (current_flags.indexOf(",2007,") < 0) {
    ...
    if (action.equals("del")) {
        gymOrder gy = new gymOrder();
        out.print(gy.delGymOrder(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    if (action.equals("batchdel")) {
        gymOrder gy = new gymOrder();
        out.print(gy.delBatchdelGymOrder(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    ...
    int order_status = ru.getInt("order_status", -1);
    int order_type = ru.getInt("order_type", -1);
    int car_type = ru.getInt("car_type");
//String plan_title=ru.getString("plan_title");
    //String order_no = new String(ru.getString("order_no").getBytes("ISO-8859-1"), "UTF-8");
    String order_no = ru.getString("order_no");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"hy_gym_order.jsp\",\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function xiangxi(id, title) {\r\n");
      out.write("            openurl('gym_order_detail.jsp?order_id=' + id + '', 'user', title, 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("    <div class=\"form_info\"><strong>订单表</strong></div>\r\n");
      ...
      out.write("                        <option value=\"-1\">--请选择订单状态--</option>\r\n");
      out.write("                        <option value=\"0\" ");
      out.print((order_status == 0 ? "selected" : "") );
      out.write(">未付款</option>\r\n");
      out.write("                        <option value=\"1\" ");
      out.print((order_status == 1 ? "selected" : "") );
      out.write(">已付款</option>\r\n");
      out.write("                        <option value=\"2\" ");
      out.print((order_status == 2 ? "selected" : "") );
      out.write(">订单取消</option>\r\n");
      out.write("                    </select>\r\n");
      out.write("                </li>\r\n");
      out.write("                <li>\r\n");
      out.write("                    订单类型：\r\n");
      out.write("                    <select name=\"order_type\" id=\"order_type\">\r\n");
      out.write("                        <option value=\"-1\">--请选择订单类型--</option>\r\n");
      out.write("                        <option value=\"0\" ");
      out.print((order_type == 0 ? "selected" : "") );
      out.write(">课程、次卡</option>\r\n");
      out.write("                        <option value=\"1\" ");
      out.print((order_type == 1 ? "selected" : "") );
      out.write(">网络计划订单</option>\r\n");
      out.write("                        <option value=\"2\" ");
      out.print((order_type == 2 ? "selected" : "") );
      out.write(">0元体验订单</option>\r\n");
      out.write("                        <option value=\"3\" ");
      out.print((order_type == 3 ? "selected" : ""));
      out.write(">积分兑换订单</option>\r\n");
      out.write("                    </select>\r\n");
      out.write("                </li>\r\n");
      out.write("                <li>\r\n");
      out.write("                    消费卡类型：\r\n");
      out.write("                    <select name=\"car_type\" id=\"car_type\">\r\n");
      out.write("                        <option value=\"0\">--请选择消费卡类型--</option>\r\n");
      out.write("                        <option value=\"1\" ");
      out.print((car_type == 1 ? "selected" : "") );
      out.write(">年卡</option>\r\n");
      out.write("                        <option value=\"2\" ");
      out.print((car_type == 2 ? "selected" : "") );
      out.write(">月卡</option>\r\n");
      out.write("                        <option value=\"3\" ");
      out.print((car_type == 3 ? "selected" : "") );
      out.write(">次卡</option>\r\n");
      out.write("                        <option value=\"4\" ");
      out.print((car_type == 4 ? "selected" : ""));
      out.write(">0元体验次卡</option>\r\n");
      out.write("                        <option value=\"5\" ");
      out.print((car_type == 5 ? "selected" : "") );
      out.write(">积分兑换次卡</option>\r\n");
      out.write("                    </select>\r\n");
      out.write("                </li>\r\n");
      ...
      out.write("                <li>订单号：<input name=\"order_no\" type=\"text\" id=\"order_no\" value=\"");
      out.print(order_no);
      out.write("\" style=\"width:100px;\"/>\r\n");
      out.write("                </li>\r\n");
      out.write("            </ul>\r\n");
      ...
      out.write("                    <th width=\"6%\">订单号</th>\r\n");
      out.write("                    <th width=\"5%\">订单总价</th>\r\n");
      out.write("                    ");
      out.write("\r\n");
      out.write("                    <th width=\"5%\">订单状态</th>\r\n");
      out.write("                    <th width=\"8%\">付款时间</th>\r\n");
      out.write("                    <th width=\"6%\">订单类型</th>\r\n");
      out.write("                    <th width=\"8%\">下单时间</th>\r\n");
      out.write("                    <th width=\"10%\">所属连锁</th>\r\n");
      out.write("                    <th width=\"10%\">健身房名称</th>\r\n");
      out.write("                    <th width=\"8%\">教练名称</th>\r\n");
      out.write("                    <th width=\"8%\">会员名称</th>\r\n");
      out.write("                    <th width=\"5%\">总课时</th>\r\n");
      out.write("                    <th width=\"5%\">剩余课时</th>\r\n");
      out.write("                    <th width=\"6%\">消费卡类型</th>\r\n");
      out.write("                    <th width=\"10%\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_gym_order a left join hy_member b on a.mem_userid=b.id left join hy_gym_group c on a.gym_group_id=c.id " +
                            " left join hy_gym d on a.gym_id=d.id left join hy_coach e on a.coach_id=e.id left join hy_gym_coach_price f on a.coach_price_id=f.id " +
                            " left join hy_gym_cost_card j on a.gym_car_id=j.id left join hy_gym_order_detail g on a.id=g.order_id";
                    ...
                    if (!"".equals(order_no)) {
                        sb.append(" and a.order_no like ?");
                        sqllist.add("%" + order_no + "%");
                    }
                    if (!"".equals(mem_name)) {
                    ...
                    if (order_status == 0) {
                        sb.append(" and a.order_status=0 ");
                    }
                    if (order_status == 1) {
                        sb.append(" and a.order_status=1 ");
                    }
                    if (order_status == 2) {
                        sb.append(" and a.order_status=2 ");
                    }
                    if (order_type == 0) {
                        sb.append(" and a.order_type=0");
                    }
                    if (order_type == 1) {
                        sb.append(" and a.order_type=1");
                    }
                    if (order_type == 2) {
                        sb.append(" and a.order_type=2");
                    }
                    if (order_type == 3) {
                        sb.append(" and a.order_type=3");
                    }
                    if (car_type == 1) {
                        sb.append(" and j.car_type=1");
                    }
                    if (car_type == 2) {
                        sb.append(" and j.car_type=2");
                    }
                    if (car_type == 3) {
                        sb.append(" and j.car_type=3");
                    }
                    if (car_type == 4) {
                        sb.append(" and j.car_type=4");
                    }
                    if (car_type == 5) {
                        sb.append(" and j.car_type=5");
                    }
                    int i = 1;
                    String file = "a.id,a.order_no,a.total,a.pay_jifen, a.order_status,a.pay_time,a.order_type,a.create_time," +
                            "  b.mem_name,b.mem_username,c.group_name,d.gym_name,e.coach_name,f.classes,g.less_classes,j.car_type ";
      ...
      out.write("                    <td>");
                        ...
                        if (doc.getIn("order_status") == 0) {
                            out.print("未付款");
                        } else if (doc.getIn("order_status") == 1) {
                            out.print("已付款");
                        } else if (doc.getI("order_status") == 2) {
                            out.print("订单取消");
                        }
                    
      out.write("</td>\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("pay_time") != 0 ? AjaxXml.timeStamp2Date(doc.getIn("pay_time"), "YY04-MM-DD HH:SS") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");

                        if (doc.getIn("order_type") == 0) {
                            out.print("课程、次卡");
                        } else if (doc.getIn("order_type") == 1) {
                            out.print("网络计划");
                        } else if (doc.getI("order_type") == 2) {
                            out.print("0元体验");
                        } else if (doc.getI("order_type") == 3) {
                            out.print("积分兑换");
                        }
                    
      out.write("</td>\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("create_time") != 0 ? AjaxXml.timeStamp2Date(doc.getIn("create_time"), "YY04-MM-DD HH:SS") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("group_name", "") != null) ? doc.get("group_name") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print((doc.get("gym_name", "") != null) ? doc.get("gym_name") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      ...
      out.write("                    <td>");
                        ...
                        if (doc.get("mem_name") != null && !("").equals(doc.get("mem_name")) && doc.get("mem_username") != null && !("").equals(doc.get("mem_username"))) {
                            out.print(URLDecoder.decode(doc.get("mem_name"), "utf-8") + "\t" + doc.get("mem_username"));
                        } else if (doc.get("mem_name") != null && !("").equals(doc.get("mem_name"))) {
                            out.print(URLDecoder.decode(doc.get("mem_name"), "utf-8"));
                        } else if (doc.get("mem_username") != null && !("").equals(doc.get("mem_username"))) {
      ...
      out.write("\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("classes"));
      out.write("小时</td>\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("less_classes"));
      out.write("小时</td>\r\n");
      out.write("                    <td>");

                        if (doc.getIn("car_type") == 1) {
                            out.print("年卡");
                        } else if (doc.getIn("car_type") == 2) {
                            out.print("月卡");
                        } else if (doc.getI("car_type") == 3) {
                            out.print("次卡");
                        } else if (doc.getI("car_type") == 4) {
                            out.print("0元体验次卡");
                        } else if (doc.getI("car_type") == 5) {
                            out.print("积分兑换次卡");
                        }
                    
      out.write("</td>\r\n");
      out.write("\r\n");
      out.write("                    <td><a href=\"javascript:xiangxi('");
      out.print(doc.get("id"));
      out.write("','订单详细')\">订单详细</a>\r\n");
      ...
      out.write("                        选中/取消所有\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td colspan=\"14\" style=\"text-align:right\"><input name=\"tjczft\" type=\"button\" onclick=\"batchdel()\"\r\n");
