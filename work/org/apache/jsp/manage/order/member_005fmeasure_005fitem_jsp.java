 ...
 * Generated at: 2015-12-30 02:16:35 UTC
...
public final class member_005fmeasure_005fitem_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    int item_type = ru.getInt("item_type");
    String item_name = ru.getString("item_name");
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"member_measure_item.jsp\",\r\n");
      ...
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("        function addItem(id, title) {\r\n");
      out.write("            openurl('member_measure_item_edit.jsp?id=' + id + '', 'user', title, 700, 380, 0, 10, true);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("    </script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("        <strong>体测项目列表</strong>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("            <li><a href=\"javascript:addItem(0,'新增体测项目')\">新增项目</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                    <th width=\"8%\">项目类型</th>\r\n");
      out.write("                    <th width=\"8%\">项目名称</th>\r\n");
      out.write("                    <th width=\"8%\">默认值</th>\r\n");
      out.write("                    <th width=\"4%\">最大值</th>\r\n");
      out.write("                    <th width=\"6%\">最小值</th>\r\n");
      out.write("                    <th width=\"8%\">第一单位</th>\r\n");
      out.write("                    <th width=\"8%\">第二单位</th>\r\n");
      out.write("                    <th width=\"12%\">创建时间</th>\r\n");
      out.write("                    <th width=\"6%\">操作</th>\r\n");
      out.write("\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table2 = "hy_member_measure_item";
                    StringBuffer wheres = new StringBuffer(" isdel=0 ");
                    String order = " order by id desc";
                    String idd = "id";
                    List list2 = new ArrayList();
                    if (item_type > 0) {
                        wheres.append(" and item_type=? ");
                        list2.add(item_type);
                    }
                    if (item_name != null && !"".equals(item_name)) {
                        wheres.append(" and item_name like ?");
                        list2.add("%" + item_name + "%");
                    }
                    JSONArray unitTypes = Units.getUnitType();
                    JSONArray actionTypes = FitnessPlanTiem.getActionType();
                    String file2 = "id,item_type,item_name,default_value,max_value,min_value,first_unit,second_unit,create_time";
      ...
      out.write("\"/></td>\r\n");
      out.write("                    <td>");
      out.print(BasicType.getItemType(doc.getIn("item_type")));
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("item_name") );
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("default_value") );
      out.write("</td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("max_value") );
      out.write("</td>\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("min_value") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("first_unit", "") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.get("second_unit", "") );
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      ...
      out.write("                        选中/取消所有\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td colspan=\"7\" style=\"text-align:right\"><input name=\"tjczft\" type=\"button\" onclick=\"batchdel()\"\r\n");
