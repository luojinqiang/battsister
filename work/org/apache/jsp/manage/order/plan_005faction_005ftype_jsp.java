 ...
 * Generated at: 2016-01-20 09:06:53 UTC
...
import com.hanyou.admin.sys.FitnessPlan;
...
public final class plan_005faction_005ftype_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.hanyou.admin.sys.FitnessPlan");
...
return;
    ...
    int type = ru.getInt("type");//0是动作类型，1是健身目标
    String flag = type == 0 ? "2026" : "2028";
    if (current_flags.indexOf("," + flag + ",") < 0) {
        response.sendRedirect("../error.jsp?left=order");
        return;
    }
    if (action.equals("batchdel")) {
        FitnessPlanTiem fitnessPlanTiem = new FitnessPlanTiem();
        out.print(fitnessPlanTiem.batchDelplan(request, userid, user_name, gym_group_id, gym_id).toString());
        return;
    }
    ...
    if (pn == 0) {
      ...
      out.write("                                type: \"post\",\r\n");
      out.write("                                url: \"plan_action_type.jsp\",\r\n");
      ...
      out.write("            openurl('plan_action_type_edit.jsp?id=' + id + '&type=");
      out.print(type);
...
if (current_flags.contains("2007")) { 
 ...
 if (current_flags.contains("5001")) { 
      ...
      out.write("\r\n");
      out.write("                    </th>\r\n");
      out.write("                    <th vidth=\"8%\">添加时间</th>\r\n");
      out.write("                    <th width=\"10%\">操作</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");

                    String table = "hy_member_action_type ";
                    StringBuffer sb = new StringBuffer(" isdel=0 and type=? ");
                    List sqllist = new ArrayList();
                    sqllist.add(type);
                    int i = 1;
                    String file = "id,type_name,create_time";
      ...
      out.write("                    </td>\r\n");
      out.write("                    <td>");
      out.print(doc.getIn("create_time") != 0 ? AjaxXml.timeStamp2Date(doc.getIn("create_time"), "YY04-MM-DD ") : "");
      out.write("\r\n");
      out.write("                    </td>\r\n");
      out.write("                    <td><a href=\"javascript:addplan('");
      out.print(doc.get("id"));
      out.write("','编辑");
      out.print(type==0?"动作类型":"健身目标" );
      out.write("')\">编辑</a> <a\r\n");
      out.write("                            href=\"javascript:batchdel(");
      out.print(doc.get("id") );
      out.write(")\">删除</a></td>\r\n");
      out.write("                </tr>\r\n");
      out.write("                ");
