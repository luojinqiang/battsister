 ...
 * Generated at: 2015-12-25 06:56:16 UTC
...
public final class pro_005fclass_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/order/../left.jsp", Long.valueOf(1450850572828L));
...
if (current_flags.indexOf(",2031,") < 0) {
	response.sendRedirect("../error.jsp?left=xinxi");
	return;
}
RequestUtil ru = new RequestUtil(request);
String action = ru.getString("action");
String account_name=ru.getString("account_name");
ProClassOpt pco = new ProClassOpt();
if(action.equals("del")){
	out.print(pco.setProClassDel(request,userid, user_name, gym_group_id, gym_id,0).toString());
	return ;
}
int class_status=ru.getInt("class_status");
      ...
      out.write("\r\n");
      out.write("function del(class_name,class_id){\r\n");
      out.write("\tvar dialog=art.dialog({\r\n");
      out.write("\t    id: 'delID',\r\n");
      out.write("\t    content: '是否确定删除栏目：'+class_name+'？',\r\n");
      out.write("\t    lock: true,\r\n");
      out.write("\t    button: [\r\n");
      out.write("\t        {\r\n");
      out.write("\t            name: '确定',\r\n");
      ...
      out.write("\t\t\t\t\t\ttype:\"post\",\r\n");
      out.write("\t\t\t\t\t\turl:\"pro_class.jsp\",\r\n");
      out.write("\t\t\t\t\t\tdata:\"action=del&class_id=\"+class_id+\"\",\r\n");
      ...
      out.write("\t});\r\n");
      out.write("}\r\n");
      out.write("function edit(id,parentid){\r\n");
      out.write("\tvar str=\"新增栏目\";\r\n");
      out.write("\tif(id>0){\r\n");
      out.write("\t\tstr=\"编辑栏目\";\r\n");
      out.write("\t}\r\n");
      out.write("\topenurl('pro_class_edit.jsp?id='+id+'&parentid='+parentid+'&class_status=");
      out.print(class_status);
      out.write("','pro',str,700,380,0,10,true);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
...
if (current_flags.contains("6001")) { 
      ...
      out.write("  <div class=\"form_info\"><strong>栏目管理</strong></div>\r\n");
      out.write(" \r\n");
      out.write("  <div class=\"btnitem mb10 clearfix\" ><ul class=\"s_btn\">\r\n");
      out.write("    <li><a href=\"javascript:edit(0,0)\">新增栏目</a></li>\r\n");
      out.write("    </ul></div>\r\n");
      out.write("  \r\n");
 ...
 List list=pco.getProClass2List(class_status,-1,"");
   
      out.write("\r\n");
      out.write("    <table cellpadding=\"0\" cellspacing=\"0\">\r\n");
      out.write("      <tr>\r\n");
      out.write("        <th width=\"70%\">栏目信息</th>\r\n");
      ...
      out.write("<tr>\r\n");
      out.write("\t\t        <td style=\"text-align:left;padding-left:");
      out.print((doc.getIn("level")+1)*10);
      out.write("px\">\t\t        \r\n");
      out.write("\t\t\t\t");

				if(doc.getIn("level")==1){
					out.print("|--");
				}
      ...
      out.write("\t\t        ");
		        ...
		        if(doc.getIn("level")<1){
		        	out.print("<a href=\"javascript:edit(0,"+doc.getIn("id")+")\">添加子栏目</a>");
		        }
